...
The lesson: `COMPAT_CHEATSHEET.md:427-430` says explicitly that
...
`findings.md:648` ("Whether multi-room check-ins use the same flow")
was already answered by the captures themselves — the answer just
never made it to writing or testing.
