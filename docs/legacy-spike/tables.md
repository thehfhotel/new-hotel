...
| `HT_Housewife` | 30,210 | Housekeeping work items. App-INSERTed when room marked CLEAN (findings.md §3j) or sent to repair — NOT on the dirty flip itself (corrected 2026-07-31, #276; findings.md §3e/§3i show check-out/cancel-check-in raise `Room_Clean='yes'` with zero `HT_Housewife` touches). | check-out (after) |
