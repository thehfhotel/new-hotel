...
(e.g. `NewHotel%402026%21` for `NewHotel@2026!` percent-encoded in
`DATABASE_URL` strings).

```
# /tmp/replacements.txt
NewHotel@2026!==><REDACTED-rotated-pg-pw>
NewHotel%402026%21==><REDACTED-rotated-pg-pw>
12345678==><REDACTED-rotated-sa-pw>
HfVille@2026!==><REDACTED-rotated-ville-pw>
banana==><REDACTED-rotated-jumpbox-pw>
```
...
git log --all -p | grep -F "NewHotel@2026!" | head -3
