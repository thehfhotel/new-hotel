    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-2xl font-bold text-zinc-100">จัดการอัตราพิเศษ</h1>
            <p className="text-zinc-400">Special Rate Management</p>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
          ...
          <div className="relative">
            ...
            <input
              ...
              className="w-full pl-10 pr-4 py-2 bg-zinc-900 text-zinc-200 border border-zinc-700 rounded-lg focus:ring-2 focus:ring-red-500 focus:border-red-500 outline-none transition-colors"
            />
            {searchQuery && (
              <button
          ...
          <div>
            <select
              ...
              className="w-full px-3 py-2 bg-zinc-900 text-zinc-200 border border-zinc-700 rounded-lg focus:ring-2 focus:ring-red-500 focus:border-red-500 outline-none transition-colors"
            >
          ...
          <div className="flex items-center">
            <label className="flex items-center gap-2 cursor-pointer">
              ...
              />
              <span className="text-sm text-zinc-300">แสดงเฉพาะที่เปิดใช้งาน</span>
            </label>
          </div>
          ...
          <div>
            <button
              ...
              className="w-full px-4 py-2 border border-zinc-700 rounded-lg text-zinc-300 hover:bg-zinc-800 transition-colors"
            >
              ล้างตัวกรอง
            </button>
          </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                        ...
                        >
                          <td className="px-4 py-3">
                            <div className="flex items-center gap-2">
                              ...
                              <span className="font-medium text-zinc-100">{rate.rateName}</span>
                            </div>
                          </td>
                          <td className="px-4 py-3">
                            <div className="flex items-center gap-2">
                              ...
                              {showDeleteConfirm === rate.id ? (
                                <div className="flex items-center gap-1">
                                  ...
                                  <button
                                    ...
                                    className="px-2 py-1 bg-zinc-800 text-zinc-200 text-xs rounded hover:bg-zinc-700 transition-colors"
                                  >
                                    ยกเลิก
                                  </button>
                                </div>
        ...
        <div className="lg:col-span-1">
          <div className="bg-zinc-900 rounded-lg p-4 mb-4">
            <h3 className="font-semibold text-zinc-300 mb-3">ดูตัวอย่างอัตราในปฏิทิน</h3>
            <select
