    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-2xl font-bold text-zinc-100">ระบบจัดการสินค้าคงคลัง</h1>
            <p className="text-zinc-400">Inventory Management</p>
          </div>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <Link href="/new/inventory/items" className="block">
          <div className="bg-zinc-900 rounded-lg border border-zinc-800 p-6 hover:border-zinc-700 transition-colors">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm text-zinc-400">สินค้าทั้งหมด</p>
        ...
        <Link href="/new/inventory/items?filter=low" className="block">
          <div className="bg-zinc-900 rounded-lg border border-zinc-800 p-6 hover:border-zinc-700 transition-colors">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm text-zinc-400">สินค้าใกล้หมด</p>
        ...
        <div className="bg-zinc-900 rounded-lg border border-zinc-800 p-6">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-sm text-zinc-400">หมวดหมู่</p>
              <p className="text-3xl font-bold text-zinc-100">
      ...
      <div className="bg-zinc-900 rounded-lg border border-zinc-800 p-4">
        <h2 className="text-lg font-semibold text-zinc-100 mb-4">การดำเนินการด่วน</h2>
              ...
              <div className="space-y-3">
                {lowStockItems.map((item) => {
                  ...
                  return (
                    <div
                      key={item.id}
                      className="flex items-center justify-between p-3 bg-zinc-800 rounded-lg hover:bg-zinc-800 transition-colors"
                    >
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          <div className="font-medium text-zinc-100">{item.itemName}</div>
                      ...
                      <div className="flex items-center gap-3">
                        <div className="text-right">
                          ...
                          <div className="text-xs text-zinc-500">ขั้นต่ำ: {item.minStock}</div>
                        </div>
                ...
                {recentTransactions.map((tx) => (
                  ...
                  >
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        <div className="font-medium text-zinc-100">{tx.itemName}</div>
