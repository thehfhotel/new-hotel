      ...
      <div className="bg-white rounded-lg border border-gray-200 p-4">
        <div className="flex flex-col lg:flex-row gap-4">
          ...
          <label className="flex items-center gap-2 cursor-pointer">
            ...
            />
            <span className="text-sm text-gray-500">แสดงเฉพาะสินค้าใกล้หมด</span>
          </label>
        </div>
            ...
            <table className="w-full">
              <thead className="bg-gray-100 border-b border-gray-200">
                <tr>
                  ...
                  <th className="px-4 py-3 text-right text-sm font-medium text-gray-500">ขั้นต่ำ</th>
                  <th className="px-4 py-3 text-right text-sm font-medium text-gray-500">คงเหลือ</th>
                  <th className="px-4 py-3 text-center text-sm font-medium text-gray-500">สถานะ</th>
                  <th className="px-4 py-3 text-center text-sm font-medium text-gray-500">การดำเนินการ</th>
                </tr>
              </thead>
              <tbody className="divide-y divide-gray-200">
                {items.map((item) => {
                  ...
                  return (
                    <tr
                      key={item.id}
                      className={`hover:bg-gray-100 ${!item.active ? 'opacity-50' : ''}`}
                    >
                      ...
                      <td className="px-4 py-3 text-right">
                        <span className={`font-bold text-lg ${
                          ...
                          status === 'critical' ? 'text-amber-600' :
                          'text-red-600'
                        }`}>
                          {item.currentStock}
                        </span>
