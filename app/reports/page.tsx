    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-gray-500">Reports Dashboard</p>
          </div>
        </div>
        <button
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <div className="bg-white rounded-lg p-6">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-sm text-gray-500">ราคาเฉลี่ยต่อคืน</p>
              <p className="text-3xl font-bold text-gray-900">
        ...
        <div className="bg-white rounded-lg p-6">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-sm text-gray-500">รายได้ต่อห้องว่าง</p>
              <p className="text-3xl font-bold text-gray-900">
        ...
        <div className="bg-white rounded-lg p-6">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-sm text-gray-500">ระยะเวลาเข้าพักเฉลี่ย</p>
              <p className="text-3xl font-bold text-gray-900">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="bg-white rounded-lg p-6">
          <h2 className="text-lg font-semibold text-gray-900 mb-4">รายได้แยกตามประเภทห้อง</h2>
          {loading ? (
            <div className="flex items-center justify-center h-80">
              <Loader2 className="w-8 h-8 animate-spin text-red-500" />
            </div>
      ...
      <div className="bg-white rounded-lg p-6">
        <h2 className="text-lg font-semibold text-gray-900 mb-4">แนวโน้มการจอง</h2>
        {loading ? (
