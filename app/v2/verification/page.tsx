...
export default function V2Verification() {
  ...
  return (
    <form onSubmit={submit} className="space-y-5 pb-8">
      ...
      <Section
        no="3"
        title="ตรวจยอดบิล 5 รายการล่าสุด (เทียบยอดรวม)"
        hint="เลือกบิลที่เช็คเอาท์แล้ว 5 รายการล่าสุด เทียบยอด iHOTEL กับยอดที่ระบบใหม่คำนวณ (ทีมไอทีช่วยเปิดยอดระบบใหม่ให้ได้)"
      >
