...
describe('Legacy Dashboard Page', () => {
  ...
  test('fetches all 5 API endpoints', async () => {
    ...
    expect(fetchCalls).toContainEqual(expect.stringContaining('/api/stats'))
    expect(fetchCalls).toContainEqual(expect.stringMatching(/\/api\/rooms\?/))
    expect(fetchCalls).toContainEqual(expect.stringContaining('/api/rooms/checkouts-today'))
    expect(fetchCalls).toContainEqual(expect.stringContaining('/api/checkins'))
    expect(fetchCalls).toContainEqual(expect.stringContaining('/api/occupancy'))
  })
})
