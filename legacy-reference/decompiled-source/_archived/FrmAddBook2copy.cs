...
[DesignerGenerated]
public class FrmAddBook2copy : Office2007Form
{
	...
	internal virtual C1FlexGrid Grid1
	{
		...
		set
		{
			RowColEventHandler value2 = Grid1_AfterEdit;
			if (_Grid1 != null)
			{
				_Grid1.AfterEdit -= value2;
			}
			_Grid1 = value;
			if (_Grid1 != null)
			{
	...
	[DebuggerNonUserCode]
	static FrmAddBook2copy()
	{
		Class2.LH6iGfYz9j3MJ();
		__ENCList = new List<WeakReference>();
	}

	public FrmAddBook2copy()
	{
		Class2.LH6iGfYz9j3MJ();
		base._002Ector();
	...
	private void InitializeComponent()
	{
		...
		System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(iHOTEL2025.FrmAddBook2copy));
		...
		location = new System.Drawing.Point(2, 53);
		label11.Location = location;
		this.Label6.Name = "Label6";
		System.Windows.Forms.Label label12 = this.Label6;
		size = new System.Drawing.Size(115, 16);
		label12.Size = size;
		...
		size = new System.Drawing.Size(344, 245);
		...
		size = new System.Drawing.Size(338, 240);
		listView2.Size = size;
		...
		this.PanelEx1.Controls.Add(this.Label53);
		this.PanelEx1.Controls.Add(this.Label54);
		...
		location = new System.Drawing.Point(561, 645);
		...
		this.Tpay.Anchor = System.Windows.Forms.AnchorStyles.Bottom | System.Windows.Forms.AnchorStyles.Left;
		...
		location = new System.Drawing.Point(325, 645);
		...
		location = new System.Drawing.Point(648, 132);
		...
		System.Windows.Forms.Label label19 = this.Label54;
		location = new System.Drawing.Point(760, 132);
		label19.Location = location;
		this.Label54.Name = "Label54";
		System.Windows.Forms.Label label20 = this.Label54;
		size = new System.Drawing.Size(24, 16);
		label20.Size = size;
		...
		location = new System.Drawing.Point(710, 128);
		...
		System.Windows.Forms.Label label21 = this.Label51;
		location = new System.Drawing.Point(376, 131);
		label21.Location = location;
		this.Label51.Name = "Label51";
		System.Windows.Forms.Label label22 = this.Label51;
		size = new System.Drawing.Size(55, 16);
		label22.Size = size;
		this.Label51.TabIndex = 79;
		this.Label51.Text = "ว\u0e31นท\u0e35\u0e48ออก";
		this.Label52.AutoSize = true;
		System.Windows.Forms.Label label23 = this.Label52;
		location = new System.Drawing.Point(96, 132);
		label23.Location = location;
		this.Label52.Name = "Label52";
		System.Windows.Forms.Label label24 = this.Label52;
		...
		size = new System.Drawing.Size(989, 469);
		grid2.Size = size;
		...
		location = new System.Drawing.Point(903, 128);
		button.Location = location;
		System.Windows.Forms.Button button2 = this.Button11;
		margin = new System.Windows.Forms.Padding(3, 4, 3, 4);
		button2.Margin = margin;
		this.Button11.Name = "Button11";
		System.Windows.Forms.Button button3 = this.Button11;
		...
		this.Label35.Anchor = System.Windows.Forms.AnchorStyles.Bottom | System.Windows.Forms.AnchorStyles.Left;
		...
		System.Windows.Forms.Label label25 = this.Label35;
		location = new System.Drawing.Point(460, 649);
		label25.Location = location;
		this.Label35.Name = "Label35";
		System.Windows.Forms.Label label26 = this.Label35;
		...
		System.Windows.Forms.Label label27 = this.Label18;
		location = new System.Drawing.Point(252, 650);
		label27.Location = location;
		this.Label18.Name = "Label18";
		System.Windows.Forms.Label label28 = this.Label18;
		size = new System.Drawing.Size(71, 16);
		label28.Size = size;
		this.Label18.TabIndex = 53;
		this.Label18.Text = "จ\u0e48ายล\u0e48วงหน\u0e49า";
		this.LabelTroom.Anchor = System.Windows.Forms.AnchorStyles.Bottom | System.Windows.Forms.AnchorStyles.Left;
		...
		location = new System.Drawing.Point(117, 646);
		...
		this.Label24.Anchor = System.Windows.Forms.AnchorStyles.Bottom | System.Windows.Forms.AnchorStyles.Left;
		...
		System.Windows.Forms.Label label29 = this.Label24;
		location = new System.Drawing.Point(22, 651);
		label29.Location = location;
		this.Label24.Name = "Label24";
		System.Windows.Forms.Label label30 = this.Label24;
		...
		location = new System.Drawing.Point(790, 128);
		...
		location = new System.Drawing.Point(906, 635);
	...
	public void listcust()
	{
		...
		checked
		{
			...
			{
				DataSet dataSet = Module1.connect("select cust_no,cust_name,cust_name2 from HT_Customers where cust_no like '%" + TextBox_0.Text + "%' or  cust_name like '%" + TextBox_0.Text + "%' or  cust_name2 like '%" + TextBox_0.Text + "%' order by cust_name");
			...
			DataSet dataSet2 = Module1.connect("select top 100 cust_no,cust_name,cust_name2 from HT_Customers order by cust_name");
			...
			while (true)
			{
				...
				if (num7 <= num4)
				{
					...
					ListViewItem.ListViewSubItemCollection subItems3 = ListView1.Items[num6].SubItems;
					array3 = new object[1];
	...
	public void chkEdit()
	{
		...
		DataSet dataSet3 = Module1.connect(Conversions.ToString(Operators.ConcatenateObject(Operators.ConcatenateObject("select * from HT_Customers where Cust_no ='", dataSet.Tables[0].Rows[0]["book_cust_id"]), "'")));
		if (dataSet3.Tables[0].Rows.Count != 0)
		{
			...
			TCusType.Text = Conversions.ToString(dataSet3.Tables[0].Rows[0]["Cust_Type"]);
	...
	public void sum()
	{
		...
		checked
		{
			...
			while (true)
			{
				...
				{
					num = decimal.Add(num, Conversions.ToDecimal(Grid1[num3, 8]));
				}
				num3++;
			}
	...
	public void SAVE_ADD()
	{
		...
		checked
		{
			...
			left = Operators.ConcatenateObject(left, ",[Book_Status],[Book_Date_in],[Book_Date_out],[Book_by],[Book_room_all],[Book_room_note])");
			...
			left = Operators.ConcatenateObject(left, string.Concat(",'" + Conversions.ToString(Tstart.Value), "'"));
			left = Operators.ConcatenateObject(left, string.Concat(",'" + Conversions.ToString(Tend.Value), "'"));
			...
			left = Operators.ConcatenateObject(left, string.Concat(",'" + text3, "'"));
			left = Operators.ConcatenateObject(left, ")");
			...
			while (true)
			{
				...
				if (Operators.CompareString(Conversions.ToString(Grid1[num15, 1]), "", TextCompare: false) != 0)
				{
					...
					left = Operators.ConcatenateObject(left, "(");
					left = Operators.ConcatenateObject(left, string.Concat(" '" + TdocNum.Text, "'"));
					left = Operators.ConcatenateObject(left, string.Concat(",'" + Conversions.ToString(Grid1[num15, 2]), "'"));
					left = Operators.ConcatenateObject(left, Operators.ConcatenateObject(Operators.ConcatenateObject(",'", Grid1[num15, 3]), "'"));
					left = Operators.ConcatenateObject(left, Operators.ConcatenateObject(Operators.ConcatenateObject(",'", Grid1[num15, 4]), "'"));
					left = Operators.ConcatenateObject(left, string.Concat(",'" + Conversions.ToString(Conversions.ToDecimal(Grid1[num15, 5])), "'"));
					left = Operators.ConcatenateObject(left, string.Concat(",'" + Conversions.ToString(Conversions.ToDecimal(Grid1[num15, 6])), "'"));
					left = Operators.ConcatenateObject(left, string.Concat(",'" + Conversions.ToString(Conversions.ToDecimal(Grid1[num15, 7])), "'"));
					left = Operators.ConcatenateObject(left, string.Concat(",'" + Conversions.ToString(Conversions.ToDecimal(Grid1[num15, 8])), "'"));
					left = Operators.ConcatenateObject(left, string.Concat(",'" + Conversions.ToString(Grid1[num15, 9]), "'"));
					left = Operators.ConcatenateObject(left, ")");
					Module1.connect(Conversions.ToString(left));
					int num17 = Convert.ToInt32(decimal.Subtract(Conversions.ToDecimal(Grid1[num15, 6]), 1m));
					int num18 = 0;
					while (true)
					{
						int num19 = num18;
						...
						DateTime dateTime = Conversions.ToDate(Grid1[num15, 3]);
						if ((decimal.Compare(Conversions.ToDecimal(Strings.Format(RuntimeHelpers.GetObjectValue(Grid1[num15, 3]), "HHmm")), 0m) >= 0) & (decimal.Compare(Conversions.ToDecimal(Strings.Format(RuntimeHelpers.GetObjectValue(Grid1[num15, 3]), "HHmm")), new decimal(Module1.CHK_IN_Before)) <= 0))
						{
						...
						left2 = Operators.ConcatenateObject(left2, string.Concat(",'" + Conversions.ToString(Grid1[num15, 2]), "'"));
						left2 = Operators.ConcatenateObject(left2, string.Concat(",'" + Conversions.ToString(dateTime.AddDays(num18).Date), "'"));
						left2 = Operators.ConcatenateObject(left2, "," + Conversions.ToString(Conversions.ToDecimal(Grid1[num15, 7])));
			...
			{
				Module1.Insert_Pay(TdocNum.Text, "จ\u0e48ายล\u0e48วงหน\u0e49า", DateTime.Now, Conversions.ToDecimal(Tpay.Text), 0m, "จ\u0e48ายล\u0e48วงหน\u0e49า", Conversions.ToDecimal(Tpay.Text), "รายการ", sIR_PAY, text, "P001", 1m, Conversions.ToDecimal(Tpay.Text), Conversions.ToDecimal(Tpay.Text), Tnote.Text, 0m, 0m, 0m);
	...
	public void SAVE_EDIT()
	{
		...
		string sIR_PAY = Module1.GetSIR_PAY();
		Module1.Insert_Pay(EDIT_ID, "แก\u0e49ไขการจองห\u0e49อง", DateTime.Now, Conversions.ToDecimal(Operators.NegateObject(dataSet.Tables[0].Rows[0]["Book_Price_Pay"])), 0m, "แก\u0e49ไขการจองห\u0e49อง", Conversions.ToDecimal(Operators.NegateObject(dataSet.Tables[0].Rows[0]["Book_Price_Pay"])), "รายการ", sIR_PAY, Conversions.ToString(dataSet.Tables[0].Rows[0]["Book_Cust_ID"]), "P001", 1m, Conversions.ToDecimal(Operators.NegateObject(dataSet.Tables[0].Rows[0]["Book_Price_Pay"])), Conversions.ToDecimal(Operators.NegateObject(dataSet.Tables[0].Rows[0]["Book_Price_Pay"])), "", 0m, 0m, 0m);
		...
		checked
		{
			...
			MessageBox.Show(Conversions.ToString(arrayList.Count));
			int num8 = arrayList.Count - 1;
			int num9 = 0;
			while (true)
			{
		...
		checked
		{
			...
			while (true)
			{
				...
				if (Operators.CompareString(Conversions.ToString(Grid1[num2, 1]), "", TextCompare: false) != 0)
				{
					...
					{
						Conversions.ToString(Grid1[num2, 2]),
						Conversions.ToString(Grid1[num2, 7])
					};
					arrayList.Add(value);
				}
				num2++;
			}
			FormSearchRooms2_old formSearchRooms2_old = new FormSearchRooms2_old();
			formSearchRooms2_old.D1 = Tstart.Value;
			formSearchRooms2_old.D2 = Tend.Value;
			formSearchRooms2_old.ShowDialog();
			if (!Operators.ConditionalCompareObjectNotEqual(formSearchRooms2_old.SelectNO, "", TextCompare: false))
			{
				return;
			}
			int num5 = 1;
			...
			DataSet dataSet = Module1.connect(Conversions.ToString(Operators.ConcatenateObject(Operators.ConcatenateObject(Operators.ConcatenateObject(Operators.ConcatenateObject("select * from HT_Rooms_Price where room_type='", formSearchRooms2_old.SelectNO), "' and room_custType='"), TCusType.Text), "' ")));
			Grid1[num5, 1] = num5;
			Grid1[num5, 2] = RuntimeHelpers.GetObjectValue(formSearchRooms2_old.SelectNO);
			Grid1[num5, 3] = Tstart.Value;
			Grid1[num5, 4] = Tend.Value;
			Grid1[num5, 5] = RuntimeHelpers.GetObjectValue(dataSet.Tables[0].Rows[0]["room_price"]);
			Grid1[num5, 6] = Tnum.Text;
			Grid1[num5, 7] = 0;
			Grid1[num5, 8] = Strings.Format(Operators.MultiplyObject(Operators.MultiplyObject(Conversions.ToDecimal(Tnum.Text), dataSet.Tables[0].Rows[0]["room_price"]), 0), "#,##0.00");
			Grid1[num5, 9] = "";
			num5++;
