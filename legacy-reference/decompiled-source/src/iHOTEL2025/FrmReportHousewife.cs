...
[DesignerGenerated]
public class FrmReportHousewife : Office2007Form
{
	...
	private void InitializeComponent()
	{
		...
		this.GroupBox1.Text = "รายงานทำความสะอาด";
		...
		location = new System.Drawing.Point(7, 56);
		label3.Location = location;
		this.Label3.Name = "Label3";
		System.Windows.Forms.Label label4 = this.Label3;
		size = new System.Drawing.Size(113, 17);
		label4.Size = size;
		this.Label3.TabIndex = 2;
		this.Label3.Text = "ผ\u0e39\u0e49ทำความสะอาด :";
		...
		this.ListView1.Columns.AddRange(new System.Windows.Forms.ColumnHeader[7] { this.ColumnHeader1, this.ColumnHeader4, this.ColumnHeader5, this.ColumnHeader3, this.ColumnHeader8, this.ColumnHeader2, this.ColumnHeader7 });
		...
		this.ColumnHeader2.Text = "ผ\u0e39\u0e49ทำความสะอาด";
		...
		this.ColumnHeader4.Text = "เลขท\u0e35\u0e48ลงทะเบ\u0e35ยน";
		this.ColumnHeader4.Width = 116;
		this.ColumnHeader5.Text = "ผ\u0e39\u0e49เข\u0e49าพ\u0e31ก";
		...
		this.Margin = margin;
		this.Name = "FrmReportHousewife";
		this.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen;
		this.Text = "รายงานทำความสะอาด";
	...
	public void loadEMP()
	{
		DataSet dataSet = Module1.connect("select * from TB_MRP_EMPLOYEE order by Emp_Name");
		...
		checked
		{
			...
			while (true)
			{
				...
				if (num3 <= num4)
				{
					ComboBox1.Items.Add(RuntimeHelpers.GetObjectValue(dataSet.Tables[0].Rows[num2]["Emp_Name"]));
					num2++;
					continue;
				}
				break;
	...
	public void search()
	{
		object left = "SELECT * from HT_Housewife";
		left = Operators.ConcatenateObject(left, string.Concat(string.Concat(string.Concat(" where (h_date between '" + Conversions.ToString(DateTimePicker1.Value), "' and '"), Conversions.ToString(DateTimePicker2.Value)), "')"));
		if (Operators.CompareString(ComboBox1.Text, "", TextCompare: false) != 0)
		{
			left = Operators.ConcatenateObject(left, string.Concat(" and h_Name like '%" + ComboBox1.Text, "%' "));
		}
		left = Operators.ConcatenateObject(left, " order by h_room");
		...
		checked
		{
			...
			while (true)
			{
				...
				if (num5 <= num6)
				{
					...
					listView.Items[count].SubItems.Add(dataSet.Tables[0].Rows[num4]["h_cin"].ToString());
					listView.Items[count].SubItems.Add(dataSet.Tables[0].Rows[num4]["h_cin_name"].ToString());
					...
					listView.Items[count].SubItems.Add(Strings.Format(RuntimeHelpers.GetObjectValue(dataSet.Tables[0].Rows[num4]["h_date"]), "dd/MM/yy HH:mm"));
