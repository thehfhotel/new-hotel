...
[DesignerGenerated]
public class FrmPayAddDebt : Office2007Form
{
	...
	[DebuggerNonUserCode]
	static FrmPayAddDebt()
	{
		Class2.LH6iGfYz9j3MJ();
		__ENCList = new List<WeakReference>();
	}

	public FrmPayAddDebt()
	{
		Class2.LH6iGfYz9j3MJ();
	...
	private void InitializeComponent()
	{
		...
		System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(iHOTEL2025.FrmPayAddDebt));
		...
		location = new System.Drawing.Point(858, 464);
		...
		location = new System.Drawing.Point(771, 464);
		...
		System.Windows.Forms.Button button13 = this.Button14;
		location = new System.Drawing.Point(1096, 284);
		button13.Location = location;
		System.Windows.Forms.Button button14 = this.Button14;
		margin = new System.Windows.Forms.Padding(3, 4, 3, 4);
		button14.Margin = margin;
		this.Button14.Name = "Button14";
		System.Windows.Forms.Button button15 = this.Button14;
		size = new System.Drawing.Size(109, 24);
		button15.Size = size;
		...
		System.Windows.Forms.Button button16 = this.Button13;
		location = new System.Drawing.Point(1009, 284);
		button16.Location = location;
		System.Windows.Forms.Button button17 = this.Button13;
		margin = new System.Windows.Forms.Padding(3, 4, 3, 4);
		button17.Margin = margin;
		this.Button13.Name = "Button13";
		System.Windows.Forms.Button button18 = this.Button13;
		size = new System.Drawing.Size(87, 24);
		button18.Size = size;
		...
		margin = new System.Windows.Forms.Padding(3, 4, 3, 4);
		this.Margin = margin;
		this.Name = "FrmPayAddDebt";
		this.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen;
		this.Text = "จ\u0e48ายเง\u0e34น (ล\u0e39กหน\u0e35\u0e49)";
	...
	private void Button7_Click(object sender, EventArgs e)
	{
		...
		{
			MessageBox.Show("กร\u0e38ณากรอกราคาให\u0e49มากกว\u0e48า 0");
			Button7.Enabled = true;
			return;
		}
		bool flag = false;
		...
		checked
		{
			...
			if (decimal.Compare(num5, 0m) > 0)
			{
				...
				while (true)
				{
					...
					if (Operators.CompareString(Conversions.ToString(Grid1[num13, 1]), "", TextCompare: false) != 0 && decimal.Compare(Conversions.ToDecimal(Grid1[num13, 11]), 0m) > 0)
					{
						Module1.Insert_Pay(TdocNum.Text, Conversions.ToString(Grid1[num13, 2]), now, 0m, 0m, "จ\u0e48ายล\u0e48วงหน\u0e49า ค\u0e48าห\u0e49อง", Conversions.ToDecimal(Grid1[num13, 14]), "รายการ", Conversions.ToString(obj2), text, "P001", Conversions.ToDecimal(Grid1[num13, 9]), Conversions.ToDecimal(Grid1[num13, 10]), Conversions.ToDecimal(Grid1[num13, 8]), "จ\u0e48ายล\u0e48วงหน\u0e49า", Conversions.ToDecimal(Grid1[num13, 11]), 0m, 0m);
					}
					num13++;
				}
				int num15 = Grid2.Rows.Count - 1;
				int num16 = 1;
				while (true)
				{
					int num17 = num16;
					...
					if (Operators.CompareString(Conversions.ToString(Grid2[num16, 1]), "", TextCompare: false) != 0)
					{
						num5 = decimal.Add(num5, Conversions.ToDecimal(Grid2[num16, 14]));
						if (decimal.Compare(Conversions.ToDecimal(Grid2[num16, 14]), 0m) > 0)
						{
							Module1.Insert_Pay(TdocNum.Text, Conversions.ToString(Grid2[num16, 2]), now, 0m, 0m, "จ\u0e48ายล\u0e48วงหน\u0e49า " + Conversions.ToString(Grid2[num16, 4]), Conversions.ToDecimal(Grid2[num16, 11]), Conversions.ToString(Grid2[num16, 5]), Conversions.ToString(obj2), text, Conversions.ToString(Grid2[num16, 13]), Conversions.ToDecimal(Grid2[num16, 6]), Conversions.ToDecimal(Grid2[num16, 8]), Conversions.ToDecimal(Grid2[num16, 7]), "จ\u0e48ายล\u0e48วงหน\u0e49า", Conversions.ToDecimal(Grid2[num16, 14]), 0m, 0m);
						}
					}
					num16++;
				}
