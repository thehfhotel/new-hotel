...
[DesignerGenerated]
public class FrmBookMain2 : Office2007Form
{
	...
	private void InitializeComponent()
	{
		...
		System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(iHOTEL2025.FrmBookMain2));
		...
		this.PanelEx1.Text = "รายการใบจองห\u0e49องพ\u0e31ก (แบบระบ\u0e38ห\u0e49อง)  |";
		...
		this.ItemContainer1.SubItems.AddRange(new DevComponents.DotNetBar.BaseItem[5] { this.ButtonCancel, this.ButtonItem2, this.ButtonItem1, this.ButtonItem3, this.ButtonItem4 });
		...
		this.ButtonCancel.Text = "เพ\u0e34\u0e48ม\r\nใบจองห\u0e49องพ\u0e31ก";
		this.ButtonCancel.Tooltip = "เพ\u0e34\u0e48ม";
		...
		this.ButtonItem1.Text = "ยกเล\u0e34ก\r\nใบจอห\u0e49องพ\u0e31ก";
		this.ButtonItem1.Tooltip = "ยกเล\u0e34ก";
		this.ButtonItem3.ButtonStyle = DevComponents.DotNetBar.eButtonStyle.ImageAndText;
		this.ButtonItem3.Image = (System.Drawing.Image)resources.GetObject("ButtonItem3.Image");
		this.ButtonItem3.ImagePosition = DevComponents.DotNetBar.eImagePosition.Top;
		this.ButtonItem3.Name = "ButtonItem3";
		this.ButtonItem3.Text = "พ\u0e34มพ\u0e4c ใบจอง";
		this.ButtonItem3.Tooltip = "พ\u0e34มพ\u0e4c";
		this.ButtonItem4.ButtonStyle = DevComponents.DotNetBar.eButtonStyle.ImageAndText;
		this.ButtonItem4.Image = (System.Drawing.Image)resources.GetObject("ButtonItem4.Image");
		this.ButtonItem4.ImagePosition = DevComponents.DotNetBar.eImagePosition.Top;
		this.ButtonItem4.Name = "ButtonItem4";
		this.ButtonItem4.Text = "ใบ Invoice";
		this.ButtonItem4.Tooltip = "พ\u0e34มพ\u0e4c";
		...
		location = new System.Drawing.Point(371, 235);
		...
		this.ListView3.Columns.AddRange(new System.Windows.Forms.ColumnHeader[7] { this.ColumnHeader21, this.ColumnHeader22, this.ColumnHeader23, this.ColumnHeader30, this.ColumnHeader24, this.ColumnHeader26, this.ColumnHeader27 });
		this.ListView3.FullRowSelect = true;
		this.ListView3.GridLines = true;
		System.Windows.Forms.ListView listView = this.ListView3;
		location = new System.Drawing.Point(373, 256);
		listView.Location = location;
		System.Windows.Forms.ListView listView2 = this.ListView3;
		margin = new System.Windows.Forms.Padding(3, 4, 3, 4);
		listView2.Margin = margin;
		this.ListView3.MultiSelect = false;
		this.ListView3.Name = "ListView3";
		System.Windows.Forms.ListView listView3 = this.ListView3;
		size = new System.Drawing.Size(496, 160);
		listView3.Size = size;
		...
		this.ColumnHeader22.Text = "ท\u0e35\u0e48";
		this.ColumnHeader22.Width = 30;
		this.ColumnHeader23.Text = "เลขห\u0e49อง";
		this.ColumnHeader23.Width = 80;
		this.ColumnHeader30.Text = "ส\u0e34นค\u0e49า";
		...
		location = new System.Drawing.Point(5, 235);
		...
		this.Label1.Text = "รายละเอ\u0e35ยดการจอง";
		...
		this.ListView2.BackColor = System.Drawing.Color.LightYellow;
		this.ListView2.CheckBoxes = true;
		this.ListView2.Columns.AddRange(new System.Windows.Forms.ColumnHeader[9] { this.ColumnHeader5, this.ColumnHeader6, this.ColumnHeader7, this.ColumnHeader10, this.ColumnHeader11, this.ColumnHeader17, this.ColumnHeader18, this.ColumnHeader16, this.ColumnHeader19 });
		this.ListView2.FullRowSelect = true;
		this.ListView2.GridLines = true;
		System.Windows.Forms.ListView listView4 = this.ListView2;
		location = new System.Drawing.Point(6, 256);
		...
		size = new System.Drawing.Size(361, 160);
		listView6.Size = size;
		...
		this.ColumnHeader7.Text = "เลขห\u0e49อง";
		...
		this.ListView1.Columns.AddRange(new System.Windows.Forms.ColumnHeader[12]
		{
			...
			this.ColumnHeader20, this.ColumnHeader25
		});
		this.ListView1.FullRowSelect = true;
		this.ListView1.GridLines = true;
		System.Windows.Forms.ListView listView7 = this.ListView1;
		location = new System.Drawing.Point(7, 100);
		listView7.Location = location;
		System.Windows.Forms.ListView listView8 = this.ListView1;
		margin = new System.Windows.Forms.Padding(3, 4, 3, 4);
		listView8.Margin = margin;
		this.ListView1.MultiSelect = false;
		this.ListView1.Name = "ListView1";
		System.Windows.Forms.ListView listView9 = this.ListView1;
		size = new System.Drawing.Size(862, 131);
		listView9.Size = size;
		...
		this.ColumnHeader25.Text = "เลขใบลงทะเบ\u0e35ยน";
		...
		margin = new System.Windows.Forms.Padding(3, 4, 3, 4);
		this.Margin = margin;
		this.Name = "FrmBookMain2";
		this.StartPosition = System.Windows.Forms.FormStartPosition.CenterParent;
		this.Text = "รายการใบจองห\u0e49องพ\u0e31ก (แบบระบ\u0e38ห\u0e49อง)";
	...
	public void Search()
	{
		...
		object left = "select * from HT_Book_H where  book_room_type=2";
		if (Operators.CompareString(TextBox_0.Text, "", TextCompare: false) != 0)
		{
			left = Operators.ConcatenateObject(left, string.Concat(" and Book_ID like '%" + TextBox_0.Text, "%'"));
		}
		...
		{
			left = Operators.ConcatenateObject(left, string.Concat(string.Concat(string.Concat(" and (Book_Date between '" + Conversions.ToString(DateTimePicker1.Value.Date), " 00:00:00' and '"), Conversions.ToString(DateTimePicker2.Value.Date)), " 23:59:59')"));
		}
		left = Operators.ConcatenateObject(left, " order by Book_ID desc");
		...
		checked
		{
			...
			while (true)
			{
				...
				if (Operators.CompareString(dataSet.Tables[0].Rows[num3]["Book_Status"].ToString(), "ยกเล\u0e34ก", TextCompare: false) == 0)
				{
					ListView1.Items[count].ForeColor = Color.White;
					ListView1.Items[count].BackColor = Color.Red;
				}
				else if (Operators.CompareString(dataSet.Tables[0].Rows[num3]["Book_Status"].ToString(), "เข\u0e49าพ\u0e31ก", TextCompare: false) == 0)
				{
				...
				ListView1.Items[count].SubItems.Add(dataSet.Tables[0].Rows[num3]["Book_room_note"].ToString());
				if (Conversions.ToBoolean(Operators.AndObject(Operators.CompareString(dataSet.Tables[0].Rows[num3]["Book_Status"].ToString(), "ยกเล\u0e34ก", TextCompare: false) != 0, Operators.CompareObjectNotEqual(dataSet.Tables[0].Rows[num3]["Book_Price_Total"], dataSet.Tables[0].Rows[num3]["Book_Price_pay"], TextCompare: false))))
				{
					ListView1.Items[count].ForeColor = Color.Blue;
				}
				num3++;
			}
	...
	private void ListView1_SelectedIndexChanged(object sender, EventArgs e)
	{
		...
		DataSet dataSet = Module1.connect("select * from HT_Book_Ds where book_no='" + ListView1.SelectedItems[0].SubItems[1].Text + "' order by id");
		DataSet dataSet2 = Module1.connect("select * from [HT_Book_Pro] where b_no='" + ListView1.SelectedItems[0].SubItems[1].Text + "' order by id");
		checked
		{
			...
			while (true)
			{
				...
				listView.Items[count].SubItems.Add(Strings.Format(RuntimeHelpers.GetObjectValue(dataSet.Tables[0].Rows[num2]["book_room_num"]), "#,##0"));
				...
				listView.Items[count].SubItems.Add(Strings.Format(RuntimeHelpers.GetObjectValue(dataSet.Tables[0].Rows[num2]["book_room_price"]), "#,##0.00"));
				listView.Items[count].SubItems.Add(Strings.Format(RuntimeHelpers.GetObjectValue(dataSet.Tables[0].Rows[num2]["book_room_priceTotal"]), "#,##0.00"));
				listView.Items[count].SubItems.Add(Strings.Format(RuntimeHelpers.GetObjectValue(dataSet.Tables[0].Rows[num2]["book_room_start"]), "dd/MM/yy HH:mm"));
				listView.Items[count].SubItems.Add(Strings.Format(RuntimeHelpers.GetObjectValue(dataSet.Tables[0].Rows[num2]["book_room_end"]), "dd/MM/yy HH:mm"));
				listView = null;
				num2++;
			}
			...
			while (true)
			{
				...
				if (num7 <= num4)
				{
					...
					listView2.Items[count2].SubItems.Add(Conversions.ToString(num6 + 1));
					...
					listView2.Items[count2].SubItems.Add(Strings.Format(RuntimeHelpers.GetObjectValue(dataSet2.Tables[0].Rows[num6]["B_PRICE"]), "#,##0.00"));
					listView2.Items[count2].SubItems.Add(Strings.Format(RuntimeHelpers.GetObjectValue(dataSet2.Tables[0].Rows[num6]["B_PRICE_TOTAL"]), "#,##0.00"));
					listView2 = null;
					num6++;
					continue;
				}
	...
	private void ButtonItem1_Click(object sender, EventArgs e)
	{
		if (ListView1.SelectedItems.Count == 0)
		{
			MessageBox.Show("กร\u0e38ณาเล\u0e37อกรายการใบจองห\u0e49องพ\u0e31ก");
			return;
		}
		DataSet dataSet = Module1.connect("select Book_ID,Book_Status,Book_Price_Pay,Book_Cust_ID from HT_Book_H where Book_ID='" + ListView1.SelectedItems[0].SubItems[1].Text + "'");
		...
		{
			Module1.connect("update HT_Rooms set room_book_ds='',Room_Book='',Room_Book_Name='',Room_Book_Time='' where room_book in (select id from ht_book_date  where Book_no='" + ListView1.SelectedItems[0].SubItems[1].Text + "')");
			Module1.connect("update HT_Book_H set Book_Status='ยกเล\u0e34ก' where Book_ID='" + ListView1.SelectedItems[0].SubItems[1].Text + "'");
			Module1.connect("update HT_Book_ds set Book_status=3 where Book_No='" + ListView1.SelectedItems[0].SubItems[1].Text + "'");
			Module1.connect("delete from  HT_Book_Date where Book_no='" + ListView1.SelectedItems[0].SubItems[1].Text + "'");
			Module1.SET_STATUS_BOOKING(ListView1.SelectedItems[0].SubItems[1].Text, bool_4: true);
	...
	private void ButtonItem2_Click(object sender, EventArgs e)
	{
		...
		if (Operators.CompareString(dataSet.Tables[0].Rows[0]["Book_Status"].ToString(), "เข\u0e49าพ\u0e31ก", TextCompare: false) == 0)
		{
			MessageBox.Show("รายการน\u0e35\u0e49ได\u0e49เข\u0e49าพ\u0e31กไปแล\u0e49ว");
			return;
		}
		FrmAddBook2 frmAddBook = new FrmAddBook2();
		frmAddBook.EDIT_ID = ListView1.SelectedItems[0].SubItems[1].Text;
		frmAddBook.ShowDialog();
		Search();
	}
	...
	private void ButtonItem3_Click(object sender, EventArgs e)
	{
		...
		{
			Print_Report.print_booking(ListView1.SelectedItems[0].SubItems[1].Text);
		}
	}
	...
	private void ButtonItem4_Click(object sender, EventArgs e)
	{
		...
		FormBookingInvoice formBookingInvoice = new FormBookingInvoice();
		formBookingInvoice.BOOKING_NO = ListView1.SelectedItems[0].SubItems[1].Text;
		formBookingInvoice.ShowDialog();
	}
}
