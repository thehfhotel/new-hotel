...
[DesignerGenerated]
public class FrmSETBranch : Office2007Form
{
	...
	private void InitializeComponent()
	{
		...
		this.ColumnHeader1.Text = "รห\u0e31สสาขา";
		this.ColumnHeader1.Width = 100;
		this.ColumnHeader2.Text = "ช\u0e37\u0e48อสาขา";
		...
		this.PanelEx2.Text = "ต\u0e31\u0e49งค\u0e48าสาขาร\u0e31บเง\u0e34น";
		...
		this.Name = "FrmSETBranch";
		this.StartPosition = System.Windows.Forms.FormStartPosition.CenterParent;
		this.Text = "ต\u0e31\u0e49งค\u0e48าสาขาร\u0e31บเง\u0e34น";
	...
	public void load_type()
	{
		...
		DataSet dataSet = Module1.connect("Select * From TB_SET_Branch  order by id_full");
	...
	private void Button2_Click(object sender, EventArgs e)
	{
		...
		{
			if (Module1.connect("SELECT * From TB_SET_Branch where name like '" + TextBox1.Text + "'").Tables[0].Rows.Count != 0)
			{
		...
		{
			Module1.connect(string.Format("Update TB_SET_Branch SET name = '{0}',id_full='{2}' WHERE id={1}", TextBox1.Text, OLD_ID, TextBox2.Text));
	...
	public void DEL_item()
	{
		if (ListView1.SelectedItems.Count != 0)
		{
			...
			{
				Module1.connect("delete from TB_SET_Branch where id=" + ListView1.SelectedItems[0].SubItems[0].Text);
	...
	private void ToolStripMenuItem_1_Click(object sender, EventArgs e)
	{
		if (ListView1.SelectedItems.Count != 0)
		{
			DataSet dataSet = Module1.connect("select * from TB_SET_Branch where id_full like '" + ListView1.SelectedItems[0].SubItems[1].Text + "%'");
			if (dataSet.Tables[0].Rows.Count != 0)
			{
