...
[DesignerGenerated]
public class ClickClean : Office2007Form
{
	...
	{
		System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(iHOTEL2025.ClickClean));
		...
		location = new System.Drawing.Point(178, 213);
		...
		location = new System.Drawing.Point(95, 389);
		...
		location = new System.Drawing.Point(11, 271);
		...
		location = new System.Drawing.Point(178, 330);
		...
		location = new System.Drawing.Point(11, 213);
		...
		size = new System.Drawing.Size(354, 453);
		...
		checked
		{
			if (!Module1.HouseWifeMode)
			{
				if (RoomArr.Count == 0)
				{
					...
					Module1.Power_set(RoomNo, "OFF", "", "ป\u0e34ดไฟจากป\u0e38\u0e48มทำความสะอาดเร\u0e35ยบร\u0e49อย");
				}
				else
				{
					int num = RoomArr.Count - 1;
					...
					while (true)
					{
						...
						Module1.Power_set(Conversions.ToString(RoomArr[num2]), "OFF", "", "ป\u0e34ดไฟจากป\u0e38\u0e48มทำความสะอาดเร\u0e35ยบร\u0e49อย");
						num2++;
					}
				}
				ISOK = true;
			...
			else
			{
				...
				while (true)
				{
					...
					Module1.Power_set(Conversions.ToString(RoomArr[num6]), "OFF", "", "ป\u0e34ดไฟจากป\u0e38\u0e48มทำความสะอาดเร\u0e35ยบร\u0e49อย");
					num6++;
				}
			}
			ISOK = true;
