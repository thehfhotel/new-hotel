...
[DesignerGenerated]
public class FrmSETMyType3 : Office2007Form
{
	...
	[DebuggerNonUserCode]
	static FrmSETMyType3()
	{
		Class2.LH6iGfYz9j3MJ();
		__ENCList = new List<WeakReference>();
	}

	public FrmSETMyType3()
	{
		Class2.LH6iGfYz9j3MJ();
	...
	private void InitializeComponent()
	{
		...
		System.Drawing.Size size = new System.Drawing.Size(498, 402);
		groupBox2.Size = size;
		...
		location = new System.Drawing.Point(58, 368);
		...
		location = new System.Drawing.Point(142, 26);
		...
		this.Label5.Text = "เล\u0e37อกประเภทบ\u0e31ญช\u0e35  :";
		this.Label1.Anchor = System.Windows.Forms.AnchorStyles.Bottom | System.Windows.Forms.AnchorStyles.Left;
		this.Label1.AutoSize = true;
		System.Windows.Forms.Label label3 = this.Label1;
		location = new System.Drawing.Point(17, 371);
		...
		location = new System.Drawing.Point(163, 371);
		...
		size = new System.Drawing.Size(470, 306);
		listView2.Size = size;
		...
		this.ColumnHeader2.Text = "ช\u0e37\u0e48อบ\u0e31ญช\u0e35";
		...
		location = new System.Drawing.Point(111, 368);
		...
		location = new System.Drawing.Point(229, 368);
		textBox5.Location = location;
		this.TextBox1.Name = "TextBox1";
		System.Windows.Forms.TextBox textBox6 = this.TextBox1;
		size = new System.Drawing.Size(181, 24);
		textBox6.Size = size;
		...
		location = new System.Drawing.Point(414, 369);
		...
		this.Name = "FrmSETMyType3";
		this.StartPosition = System.Windows.Forms.FormStartPosition.CenterParent;
		this.Text = "ต\u0e31\u0e49งค\u0e48ารห\u0e31สบ\u0e31ญช\u0e35";
	...
	{
		DataSet dataSet = Module1.connect("select * from TB_SET_MyType2_2 order by id_full");
	...
	public void load_type()
	{
		...
		DataSet dataSet = Module1.connect("Select * From TB_SET_MyType3 where id_full like '" + TextBox3.Text + "%' order by id_full");
	...
	private void Button2_Click(object sender, EventArgs e)
	{
		...
		{
			MessageBox.Show("กร\u0e38ณากรอกช\u0e37\u0e48อรห\u0e31สบ\u0e31ญช\u0e35");
			return;
		}
		if (Operators.CompareString(TextBox2.Text, "", TextCompare: false) == 0)
		{
			MessageBox.Show("กร\u0e38ณากรอกรห\u0e31สรห\u0e31สบ\u0e31ญช\u0e35");
			return;
		}
		if (Operators.ConditionalCompareObjectEqual(Button1.Text, Badd, TextCompare: false))
		{
			if (Module1.connect("SELECT * From TB_SET_MyType3 where name like '" + TextBox1.Text + "'").Tables[0].Rows.Count != 0)
			{
				MessageBox.Show("ม\u0e35ช\u0e37\u0e48อรห\u0e31สบ\u0e31ญช\u0e35น\u0e35\u0e49อย\u0e39\u0e48แล\u0e49ว");
			}
			else
			{
				object obj = "";
				obj = "INSERT INTO [TB_SET_MyType3]";
				...
				MessageBox.Show("เพ\u0e34\u0e48มช\u0e37\u0e48อรห\u0e31สบ\u0e31ญช\u0e35เร\u0e35ยบร\u0e49อย");
			}
		}
		else
		{
			Module1.connect(string.Format("Update TB_SET_MyType3 SET name = '{0}',id_full='{2}' WHERE id={1}", TextBox1.Text, OLD_ID, TextBox3.Text + TextBox2.Text));
	...
	public void DEL_item()
	{
		...
		{
			string left = ListView1.SelectedItems[0].SubItems[1].Text;
			if ((Operators.CompareString(left, "40101", TextCompare: false) == 0) | (Operators.CompareString(left, "30101", TextCompare: false) == 0))
			{
				MessageBox.Show("รห\u0e31ส 40101 และ 30101 ไม\u0e48สามารถ ลบ ได\u0e49");
			}
			...
			{
				Module1.connect("delete from TB_SET_MyType3 where id=" + ListView1.SelectedItems[0].SubItems[0].Text);
