...
[DesignerGenerated]
public class FormSearchPro : Office2007Form
{
	...
	private void InitializeComponent()
	{
		...
		System.Drawing.Point location = new System.Drawing.Point(76, 12);
		...
		this.ListView1.Columns.AddRange(new System.Windows.Forms.ColumnHeader[5] { this.ColumnHeader1, this.ColumnHeader2, this.ColumnHeader6, this.ColumnHeader3, this.ColumnHeader5 });
		...
		size = new System.Drawing.Size(665, 273);
		listView2.Size = size;
		...
		this.ColumnHeader6.Text = "ช\u0e37\u0e48อส\u0e34นค\u0e49า";
		this.ColumnHeader6.Width = 200;
		this.ColumnHeader3.Text = "หมวดส\u0e34นค\u0e49า";
		this.ColumnHeader3.Width = 130;
		this.ColumnHeader5.Text = "จำนวนคงเหล\u0e37อ";
		this.ColumnHeader5.TextAlign = System.Windows.Forms.HorizontalAlignment.Right;
		this.ColumnHeader5.Width = 110;
		System.Windows.Forms.Button button = this.Button4;
		location = new System.Drawing.Point(614, 451);
		...
		size = new System.Drawing.Size(665, 109);
		listView4.Size = size;
		...
		size = new System.Drawing.Size(694, 486);
	...
	public void Search()
	{
		...
		{
			right = " where Pro_name like '%" + TextBox1.Text + "%'";
		}
		DataSet dataSet = Module1.connect(Conversions.ToString(Operators.ConcatenateObject(Operators.ConcatenateObject("select * from HT_Products ", right), " order by Pro_name")));
	...
	private void ListView1_SelectedIndexChanged(object sender, EventArgs e)
	{
		checked
		{
			if (ListView1.SelectedItems.Count != 0)
			{
				...
				dataSet = Module1.connect("select * from HT_Products_Price where P_ID='" + ListView1.SelectedItems[0].SubItems[1].Text + "'");
				...
				while (true)
				{
					...
					while (true)
					{
						...
						if (Operators.ConditionalCompareObjectEqual(ListView2.Items[num6].SubItems[0].Text, dataSet.Tables[0].Rows[num9]["p_CustType"], TextCompare: false))
						{
							ListView2.Items[num6].SubItems[1].Text = Conversions.ToString(dataSet.Tables[0].Rows[num9]["p_Price"]);
						}
						num9++;
					}
					num6++;
