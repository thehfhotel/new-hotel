...
[DesignerGenerated]
public class FrmReportPower : Office2007Form
{
	...
	private void InitializeComponent()
	{
		...
		this.GroupBox1.Text = "รายงานการเป\u0e34ด-ป\u0e34ดไฟ";
		this.ComboBox1.DropDownStyle = System.Windows.Forms.ComboBoxStyle.DropDownList;
		this.ComboBox1.FormattingEnabled = true;
		this.ComboBox1.Items.AddRange(new object[3] { "เร\u0e35ยงตามห\u0e49อง", "เร\u0e35ยงตามว\u0e31นท\u0e35\u0e48เป\u0e34ดไฟ", "เร\u0e35ยงตามว\u0e31นท\u0e35\u0e48ป\u0e34ดไฟ" });
		System.Windows.Forms.ComboBox comboBox = this.ComboBox1;
		location = new System.Drawing.Point(122, 53);
		...
		size = new System.Drawing.Size(106, 17);
		label6.Size = size;
		this.Label1.TabIndex = 2;
		this.Label1.Text = "จากว\u0e31นท\u0e35\u0e48เป\u0e34ดไฟ :";
		this.ListView1.Anchor = System.Windows.Forms.AnchorStyles.Top | System.Windows.Forms.AnchorStyles.Bottom | System.Windows.Forms.AnchorStyles.Left | System.Windows.Forms.AnchorStyles.Right;
		this.ListView1.Atto_กระดาษแนวนอน = false;
		this.ListView1.Columns.AddRange(new System.Windows.Forms.ColumnHeader[9] { this.ColumnHeader1, this.ColumnHeader4, this.ColumnHeader5, this.ColumnHeader3, this.ColumnHeader9, this.ColumnHeader8, this.ColumnHeader2, this.ColumnHeader7, this.ColumnHeader6 });
		...
		size = new System.Drawing.Size(1033, 394);
		listView2.Size = size;
		...
		this.ColumnHeader4.Text = "เลขห\u0e49อง";
		this.ColumnHeader4.Width = 80;
		this.ColumnHeader5.Text = "ว\u0e31นท\u0e35\u0e48เป\u0e34ดไฟ";
		this.ColumnHeader5.Width = 120;
		this.ColumnHeader3.Text = "ว\u0e31นท\u0e35\u0e48ป\u0e34ดไฟ";
		this.ColumnHeader3.Width = 120;
		this.ColumnHeader8.Text = "ผ\u0e39\u0e49เป\u0e34ดไฟ";
		this.ColumnHeader8.Width = 100;
		this.ColumnHeader2.Text = "ผ\u0e39\u0e49ป\u0e34ดไฟ";
		this.ColumnHeader2.Width = 100;
		this.ColumnHeader7.Text = "หมายเหต\u0e38 เป\u0e34ดไฟ";
		...
		this.ColumnHeader6.Text = "หมายเหต\u0e38 ป\u0e34ดไฟ";
		this.ColumnHeader6.Width = 350;
		this.Label4.AutoSize = true;
		System.Windows.Forms.Label label7 = this.Label4;
		location = new System.Drawing.Point(306, 57);
		...
		this.ComboBox2.Items.AddRange(new object[3] { "เร\u0e35ยงตามห\u0e49อง", "เร\u0e35ยงตามว\u0e31นท\u0e35\u0e48เป\u0e34ดไฟ", "เร\u0e35ยงตามว\u0e31นท\u0e35\u0e48ป\u0e34ดไฟ" });
		System.Windows.Forms.ComboBox comboBox3 = this.ComboBox2;
		location = new System.Drawing.Point(371, 53);
		...
		this.ColumnHeader9.Text = "ระยะเวลา";
		...
		this.Margin = margin;
		this.Name = "FrmReportPower";
		this.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen;
		this.Text = "รายงานการเป\u0e34ด-ป\u0e34ดไฟ";
	...
	public void search()
	{
		object left = "SELECT * from HT_POWER_LOG";
		left = Operators.ConcatenateObject(left, string.Concat(string.Concat(string.Concat(" where (ROOM_POWER_START between '" + Conversions.ToString(DateTimePicker1.Value), "' and '"), Conversions.ToString(DateTimePicker2.Value)), "')"));
		if (Operators.CompareString(ComboBox2.Text, "ท\u0e31\u0e49งหมด", TextCompare: false) != 0)
		{
			left = Operators.ConcatenateObject(left, string.Concat(" and ROOM_NO='" + ComboBox2.Text, "'"));
		}
		if (Operators.CompareString(ComboBox1.Text, "เร\u0e35ยงตามห\u0e49อง", TextCompare: false) == 0)
		{
			left = Operators.ConcatenateObject(left, " order by ROOM_NO");
		}
		else if (Operators.CompareString(ComboBox1.Text, "เร\u0e35ยงตามว\u0e31นท\u0e35\u0e48เป\u0e34ดไฟ", TextCompare: false) == 0)
		{
			left = Operators.ConcatenateObject(left, " order by ROOM_POWER_START");
		}
		else if (Operators.CompareString(ComboBox1.Text, "เร\u0e35ยงตามว\u0e31นท\u0e35\u0e48ป\u0e34ดไฟ", TextCompare: false) == 0)
		{
			left = Operators.ConcatenateObject(left, " order by ROOM_POWER_END");
		}
		...
		checked
		{
			...
			while (true)
			{
				...
				listView.Items[count].SubItems.Add(dataSet.Tables[0].Rows[num5]["ROOM_NO"].ToString());
				listView.Items[count].SubItems.Add(Strings.Format(RuntimeHelpers.GetObjectValue(dataSet.Tables[0].Rows[num5]["ROOM_POWER_START"]), "dd/MM/yy HH:mm"));
				if (Operators.CompareString(dataSet.Tables[0].Rows[num5]["ROOM_POWER_END"].ToString(), "", TextCompare: false) == 0)
				{
				...
				{
					listView.Items[count].SubItems.Add(Strings.Format(RuntimeHelpers.GetObjectValue(dataSet.Tables[0].Rows[num5]["ROOM_POWER_END"]), "dd/MM/yy HH:mm"));
					int num8 = (int)DateAndTime.DateDiff(DateInterval.Minute, Conversions.ToDate(dataSet.Tables[0].Rows[num5]["ROOM_POWER_START"]), Conversions.ToDate(dataSet.Tables[0].Rows[num5]["ROOM_POWER_END"]));
					listView.Items[count].SubItems.Add(Module1.Convert_Minites_TO_Hour(num8));
					num3 += num8;
				}
				...
				string columnName = "ROOM_POWER_START_BY";
				...
				if (dataSet.Tables[0].Rows[num5]["ROOM_POWER_NOTE"].ToString().IndexOf("เป\u0e34ดไฟโดยพน\u0e31กงาน") != -1)
				{
					listView.Items[count].ForeColor = Color.Blue;
				}
				if (dataSet.Tables[0].Rows[num5]["ROOM_POWER_NOTE2"].ToString().IndexOf("ยกเล\u0e34ก") != -1)
				{
			...
			listView2.Items.Add("รวม");
			listView2.Items[count2].SubItems.Add("");
			listView2.Items[count2].SubItems.Add("");
			listView2.Items[count2].SubItems.Add("");
			listView2.Items[count2].SubItems.Add(Module1.Convert_Minites_TO_Hour(num3));
			listView2.Items[count2].SubItems.Add("");
			listView2.Items[count2].SubItems.Add("");
			listView2.Items[count2].SubItems.Add("");
			listView2.Items[count2].SubItems.Add("");
	...
	public void list_room()
	{
		...
		DataSet dataSet = Module1.connect("select room_no from HT_Rooms order by room_no");
		checked
		{
			...
			while (true)
			{
				...
				ComboBox2.Items.Add(RuntimeHelpers.GetObjectValue(dataSet.Tables[0].Rows[num2]["room_no"]));
				num2++;
			}
