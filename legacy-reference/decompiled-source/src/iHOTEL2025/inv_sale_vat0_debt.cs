...
public class inv_sale_vat0_debt : ReportClass
{
	...
	public override string FullResourceName
	{
		get
		{
			return "iHOTEL2025.inv_sale_vat0_debt.rpt";
		}
		set
		{
		}
	...
	[DebuggerNonUserCode]
	static inv_sale_vat0_debt()
	{
		Class2.LH6iGfYz9j3MJ();
		__ENCList = new List<WeakReference>();
	}

	public inv_sale_vat0_debt()
	{
		Class2.LH6iGfYz9j3MJ();
