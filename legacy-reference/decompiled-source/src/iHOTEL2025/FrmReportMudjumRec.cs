...
[DesignerGenerated]
public class FrmReportMudjumRec : Office2007Form
{
	...
	private void InitializeComponent()
	{
		...
		this.GroupBox1.Text = "รายงานร\u0e31บเง\u0e34นม\u0e31ดจำ";
		this.ListView1.Anchor = System.Windows.Forms.AnchorStyles.Top | System.Windows.Forms.AnchorStyles.Bottom | System.Windows.Forms.AnchorStyles.Left | System.Windows.Forms.AnchorStyles.Right;
		this.ListView1.Atto_กระดาษแนวนอน = true;
		this.ListView1.Columns.AddRange(new System.Windows.Forms.ColumnHeader[10] { this.ColumnHeader3, this.ColumnHeader2, this.ColumnHeader12, this.ColumnHeader9, this.ColumnHeader13, this.ColumnHeader14, this.ColumnHeader1, this.ColumnHeader5, this.ColumnHeader6, this.ColumnHeader7 });
		...
		this.ColumnHeader12.Text = "ว\u0e31นท\u0e35\u0e48ร\u0e31บเง\u0e34น";
		...
		this.Margin = margin;
		this.Name = "FrmReportMudjumRec";
		this.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen;
		this.Text = "รายงานร\u0e31บเง\u0e34นม\u0e31ดจำ";
	...
	public void Search()
	{
		...
		checked
		{
			...
			while (true)
			{
				...
				ListView1.Items[num].SubItems.Add(Strings.Format(RuntimeHelpers.GetObjectValue(dataSet.Tables[0].Rows[num4]["Cin_Date"]), "dd/MM/yyyy HH:mm"));
				...
				ListViewItem.ListViewSubItemCollection subItems2 = ListView1.Items[num].SubItems;
				array3 = new object[1];
				...
				if (Operators.CompareString(dataSet.Tables[0].Rows[num4]["cin_Dep_Status"].ToString(), "ยกเล\u0e34ก", TextCompare: false) == 0)
				{
					ListView1.Items[num].ForeColor = Color.White;
					ListView1.Items[num].BackColor = Color.Red;
				}
				else if (Operators.CompareString(dataSet.Tables[0].Rows[num4]["cin_Dep_Status"].ToString(), "ย\u0e31งไม\u0e48ค\u0e37นค\u0e48าม\u0e31ดจำ", TextCompare: false) == 0)
				{
					ListView1.Items[num].BackColor = Color.Yellow;
				}
				ListView1.Items[num].SubItems.Add(dataSet.Tables[0].Rows[num4]["Dep_by"].ToString());
				if (Operators.CompareString(dataSet.Tables[0].Rows[num4]["Cin_Dep_return_date"].ToString(), "", TextCompare: false) != 0)
				{
