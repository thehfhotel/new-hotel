...
public class ReportBookingINV : ReportClass
{
	...
	public override string FullResourceName
	{
		get
		{
			return "iHOTEL2025.ReportBookingINV.rpt";
		}
		set
		{
		}
	...
	[DebuggerNonUserCode]
	static ReportBookingINV()
	{
		Class2.LH6iGfYz9j3MJ();
		__ENCList = new List<WeakReference>();
	}

	public ReportBookingINV()
	{
		Class2.LH6iGfYz9j3MJ();
