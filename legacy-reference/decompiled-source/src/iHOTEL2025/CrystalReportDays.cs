...
public class CrystalReportDays : ReportClass
{
	...
	public override string FullResourceName
	{
		get
		{
			return "iHOTEL2025.CrystalReportDays.rpt";
		}
		set
		{
		}
	...
	[DebuggerNonUserCode]
	static CrystalReportDays()
	{
		Class2.LH6iGfYz9j3MJ();
		__ENCList = new List<WeakReference>();
	}

	public CrystalReportDays()
	{
		Class2.LH6iGfYz9j3MJ();
