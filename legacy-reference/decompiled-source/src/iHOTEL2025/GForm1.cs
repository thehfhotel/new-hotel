...
[DesignerGenerated]
public class GForm1 : Office2007Form
{
	...
	private void InitializeComponent()
	{
		...
		size = new System.Drawing.Size(1003, 404);
		listView2.Size = size;
		...
		location = new System.Drawing.Point(952, 451);
		...
		this.ColumnHeader7.Text = "จำนวนเง\u0e34นท\u0e35\u0e48สามารถออก VAT ได\u0e49";
		this.ColumnHeader7.TextAlign = System.Windows.Forms.HorizontalAlignment.Right;
		this.ColumnHeader7.Width = 200;
		System.Drawing.SizeF sizeF = new System.Drawing.SizeF(7f, 16f);
		this.AutoScaleDimensions = sizeF;
		this.AutoScaleMode = System.Windows.Forms.AutoScaleMode.Font;
		size = new System.Drawing.Size(1032, 486);
		...
		this.Margin = margin;
		this.Name = "FormSearchChechInVAT";
		this.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen;
		this.Text = "ค\u0e49นหารายการเข\u0e49าพ\u0e31ก";
		this.TopMost = true;
	...
	public void Search()
	{
		...
		DataSet dataSet = Module1.connect(Conversions.ToString(Operators.ConcatenateObject(Operators.ConcatenateObject("select top 200 * from View_CheckIn_H ", obj), " and cin_status='ปกต\u0e34' order by Cin_no desc")));
		...
		checked
		{
			...
			while (true)
			{
				...
				if (num3 <= num4)
				{
					...
					listView.Items[num2].SubItems.Add(Strings.Format(RuntimeHelpers.GetObjectValue(dataSet.Tables[0].Rows[num2]["EN_VAT"]), "#,##0.00"));
					listView = null;
					num2++;
					continue;
				}
