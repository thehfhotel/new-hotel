...
[DesignerGenerated]
public class FrmReportrepair : Office2007Form
{
	...
	private void InitializeComponent()
	{
		...
		this.GroupBox1.Text = "รายงานการซ\u0e48อม";
		...
		this.ColumnHeader2.Text = "ผ\u0e39\u0e49ทำรายการ";
		...
		this.Margin = margin;
		this.Name = "FrmReportrepair";
		this.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen;
		this.Text = "รายงานการซ\u0e48อม";
	...
	public void search()
	{
		object left = "SELECT * from HT_Rooms_Repair";
		left = Operators.ConcatenateObject(left, string.Concat(string.Concat(string.Concat(" where (Repair_date between '" + Conversions.ToString(DateTimePicker1.Value), "' and '"), Conversions.ToString(DateTimePicker2.Value)), "')"));
		left = Operators.ConcatenateObject(left, " order by Repair_date");
		...
		checked
		{
			...
			while (true)
			{
				...
				if (num5 <= num6)
				{
					...
					listView.Items[count].SubItems.Add(Strings.Format(RuntimeHelpers.GetObjectValue(dataSet.Tables[0].Rows[num4]["Repair_date"]), "dd/MM/yy HH:mm"));
					ListViewItem.ListViewSubItemCollection subItems2 = listView.Items[count].SubItems;
					array3 = new object[1];
					object[] array5 = array3;
					dataRow = dataSet.Tables[0].Rows[num4];
					DataRow dataRow3 = dataRow;
					columnName = "Repair_by";
					...
					listView.Items[count].SubItems.Add(dataSet.Tables[0].Rows[num4]["Repair_note"].ToString());
					listView = null;
					num4++;
					continue;
				}
