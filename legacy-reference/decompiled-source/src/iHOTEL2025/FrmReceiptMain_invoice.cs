...
[DesignerGenerated]
public class FrmReceiptMain_invoice : Office2007Form
{
	...
	private void InitializeComponent()
	{
		...
		System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(iHOTEL2025.FrmReceiptMain_invoice));
		...
		size = new System.Drawing.Size(100, 420);
		...
		size = new System.Drawing.Size(94, 383);
		...
		this.ItemContainer1.SubItems.AddRange(new DevComponents.DotNetBar.BaseItem[4] { this.ButtonAdd, this.ButtonItem2, this.ButtonCancel, this.ButtonItem1 });
		...
		this.ButtonAdd.Tooltip = "เพ\u0e34\u0e48มใบสำค\u0e31ญร\u0e31บเง\u0e34น";
		this.ButtonAdd.Visible = false;
		this.ButtonItem2.ButtonStyle = DevComponents.DotNetBar.eButtonStyle.ImageAndText;
		this.ButtonItem2.Image = (System.Drawing.Image)resources.GetObject("ButtonItem2.Image");
		this.ButtonItem2.ImagePosition = DevComponents.DotNetBar.eImagePosition.Top;
		this.ButtonItem2.Name = "ButtonItem2";
		this.ButtonItem2.Text = "แก\u0e49ไข\r\nใบสำค\u0e31ญร\u0e31บเง\u0e34น";
		this.ButtonItem2.Tooltip = "ยกเล\u0e34ก";
		...
		location = new System.Drawing.Point(100, 24);
		...
		size = new System.Drawing.Size(864, 420);
		panelEx6.Size = size;
		...
		DevComponents.DotNetBar.ItemPanel itemPanel4 = this.ItemPanel1;
		location = new System.Drawing.Point(616, 225);
		itemPanel4.Location = location;
		this.ItemPanel1.MultiLine = true;
		this.ItemPanel1.Name = "ItemPanel1";
		this.ItemPanel1.ResizeItemsToFit = false;
		DevComponents.DotNetBar.ItemPanel itemPanel5 = this.ItemPanel1;
		size = new System.Drawing.Size(244, 26);
		itemPanel5.Size = size;
		...
		location = new System.Drawing.Point(6, 235);
		...
		size = new System.Drawing.Size(853, 85);
		groupBox4.Size = size;
		...
		location = new System.Drawing.Point(52, 23);
		...
		this.ListView2.Columns.AddRange(new System.Windows.Forms.ColumnHeader[4] { this.ColumnHeader6, this.ColumnHeader15, this.ColumnHeader8, this.ColumnHeader18 });
		...
		size = new System.Drawing.Size(853, 160);
		listView3.Size = size;
		this.ListView2.TabIndex = 15;
		this.ListView2.UseCompatibleStateImageBehavior = false;
		this.ListView2.View = System.Windows.Forms.View.Details;
		this.ColumnHeader6.Text = "ท\u0e35\u0e48";
		this.ColumnHeader6.Width = 50;
		this.ColumnHeader15.Text = "เลขห\u0e49อง";
		this.ColumnHeader15.Width = 100;
		this.ColumnHeader8.Text = "รายการ";
		this.ColumnHeader8.Width = 150;
		this.ColumnHeader18.Text = "รวม";
		...
		{
			this.ColumnHeader4, this.ColumnHeader12, this.ColumnHeader13, this.ColumnHeader14, this.ColumnHeader7, this.ColumnHeader9, this.ColumnHeader10, this.ColumnHeader11, this.ColumnHeader16, this.ColumnHeader1,
		...
		size = new System.Drawing.Size(853, 126);
		listView6.Size = size;
		...
		this.ColumnHeader12.Text = "เลขท\u0e35\u0e48";
		this.ColumnHeader12.Width = 100;
		this.ColumnHeader13.Text = "ว\u0e31นท\u0e35\u0e48";
		this.ColumnHeader13.Width = 140;
		this.ColumnHeader14.Text = "ช\u0e37\u0e48อล\u0e39กค\u0e49า";
		this.ColumnHeader14.Width = 240;
		this.ColumnHeader7.Text = "เง\u0e34นสด";
		this.ColumnHeader7.TextAlign = System.Windows.Forms.HorizontalAlignment.Right;
		this.ColumnHeader7.Width = 80;
		this.ColumnHeader9.Text = "บ\u0e31ตร";
		...
		this.ColumnHeader1.Text = "ราคารวม";
		this.ColumnHeader1.TextAlign = System.Windows.Forms.HorizontalAlignment.Right;
		this.ColumnHeader1.Width = 90;
		this.ColumnHeader2.Text = "สถานะ";
		this.ColumnHeader2.Width = 120;
		this.ColumnHeader3.Text = "อ\u0e49างอ\u0e34ง";
		this.ColumnHeader3.Width = 180;
		this.ColumnHeader5.Text = "จ\u0e31ดทำโดย";
		this.ColumnHeader5.Width = 100;
		this.ColumnHeader16.Text = "เว\u0e47บไซต\u0e4c";
		...
		margin = new System.Windows.Forms.Padding(3, 4, 3, 4);
		this.Margin = margin;
		this.Name = "FrmReceiptMain_invoice";
		this.StartPosition = System.Windows.Forms.FormStartPosition.CenterParent;
		this.Text = "ใบสำค\u0e31ญร\u0e31บ";
	...
	private void ButtonAdd_Click(object sender, EventArgs e)
	{
		...
		MyProject.Forms.FrmAddSale2.IEdit = 0;
		MyProject.Forms.FrmAddSale2.clear();
		MyProject.Forms.FrmAddSale2.ShowDialog();
		Search();
	...
	{
		Cursor = Cursors.WaitCursor;
		object left = "select pay_by,Cin_No,pay_no,cin_pay_date,Cust_name,Cin_Pay_Cash,Cin_Pay_web,Cin_Pay_Credit,Cin_Pay_Free,cin_status,Cin_Pay_tran from view_pay_ds where pay_no<>''";
		if (Operators.CompareString(TextBox_0.Text, "", TextCompare: false) != 0)
		{
			left = Operators.ConcatenateObject(left, string.Concat(" and pay_no like '%" + TextBox_0.Text, "%'"));
		}
		...
		{
			left = Operators.ConcatenateObject(left, string.Concat(string.Concat(string.Concat(" and (cin_pay_date between '" + Conversions.ToString(DateTimePicker1.Value.Date), " 00:00:00' and '"), Conversions.ToString(DateTimePicker2.Value.Date)), " 23:59:59')"));
		}
		left = Operators.ConcatenateObject(left, " group by pay_by,Cin_No,pay_no,cin_pay_date,Cust_name,Cin_Pay_Cash,Cin_Pay_web,Cin_Pay_Credit,Cin_Pay_Free,cin_status,Cin_Pay_tran order by pay_no desc");
		...
		checked
		{
			...
			while (true)
			{
				...
				ListView1.Items[count].SubItems.Add(dataSet.Tables[0].Rows[num3]["pay_no"].ToString());
				ListView1.Items[count].SubItems.Add(Strings.Format(RuntimeHelpers.GetObjectValue(dataSet.Tables[0].Rows[num3]["cin_pay_date"]), "dd/MM/yyyy HH:mm"));
				ListView1.Items[count].SubItems.Add(dataSet.Tables[0].Rows[num3]["Cust_name"].ToString());
				ListView1.Items[count].SubItems.Add(Strings.Format(RuntimeHelpers.GetObjectValue(dataSet.Tables[0].Rows[num3]["Cin_Pay_Cash"]), "#,##0.00"));
				ListView1.Items[count].SubItems.Add(Strings.Format(RuntimeHelpers.GetObjectValue(dataSet.Tables[0].Rows[num3]["Cin_Pay_Credit"]), "#,##0.00"));
				ListView1.Items[count].SubItems.Add(Strings.Format(RuntimeHelpers.GetObjectValue(dataSet.Tables[0].Rows[num3]["Cin_Pay_tran"]), "#,##0.00"));
				ListView1.Items[count].SubItems.Add(Strings.Format(RuntimeHelpers.GetObjectValue(dataSet.Tables[0].Rows[num3]["Cin_Pay_Free"]), "#,##0.00"));
				ListView1.Items[count].SubItems.Add(Strings.Format(RuntimeHelpers.GetObjectValue(dataSet.Tables[0].Rows[num3]["Cin_Pay_web"]), "#,##0.00"));
				ListView1.Items[count].SubItems.Add(Strings.Format(Operators.AddObject(Operators.AddObject(Operators.AddObject(dataSet.Tables[0].Rows[num3]["Cin_Pay_Cash"], dataSet.Tables[0].Rows[num3]["Cin_Pay_Credit"]), dataSet.Tables[0].Rows[num3]["Cin_Pay_tran"]), dataSet.Tables[0].Rows[num3]["Cin_Pay_web"]), "#,##0.00"));
				object[] array3;
				DataRow dataRow;
				string columnName;
				object[] array;
				bool[] array4;
				if (Operators.ConditionalCompareObjectEqual(dataSet.Tables[0].Rows[num3]["cin_status"], "1", TextCompare: false))
				{
					ListView1.Items[count].SubItems.Add("ปกต\u0e34");
				}
				else
				{
				...
				{
					num = Conversions.ToDecimal(Operators.AddObject(num, Operators.AddObject(Operators.AddObject(Operators.AddObject(dataSet.Tables[0].Rows[num3]["Cin_Pay_Cash"], dataSet.Tables[0].Rows[num3]["Cin_Pay_Credit"]), dataSet.Tables[0].Rows[num3]["Cin_Pay_tran"]), dataSet.Tables[0].Rows[num3]["Cin_Pay_web"])));
				}
				ListView1.Items[count].SubItems.Add(dataSet.Tables[0].Rows[num3]["pay_by"].ToString());
				num3++;
			}
			Lsell.Text = Strings.Format(num, "#,##0.00");
			Cursor = Cursors.Default;
		}
	}
	...
	private void ButtonCancel_Click(object sender, EventArgs e)
	{
		...
		{
			MessageBox.Show("กร\u0e38ณาเล\u0e37อกรายการใบสำค\u0e31ญร\u0e31บเง\u0e34น");
			return;
		}
		DataSet dataSet = Module1.connect("select cin_no,cin_status as status_name from HT_CheckIn_Pay where pay_no='" + ListView1.SelectedItems[0].SubItems[1].Text + "'");
		checked
		{
			...
			else if (dataSet.Tables[0].Rows[0]["cin_no"].ToString().LastIndexOf("CH") != -1)
			{
				MessageBox.Show("ไม\u0e48สามารถยกเล\u0e34กรายการน\u0e35\u0e49ได\u0e49เน\u0e37\u0e48องจากรายการน\u0e35\u0e49ได\u0e49ทำมาจากหน\u0e49า Check-In");
			}
			else
			{
				if (MessageBox.Show("ค\u0e38ณต\u0e49องการยกเล\u0e34กใบสำค\u0e31ญร\u0e31บเง\u0e34นหร\u0e37อไม\u0e48", "ยกเล\u0e34กใบสำค\u0e31ญร\u0e31บเง\u0e34น", MessageBoxButtons.YesNo, MessageBoxIcon.Asterisk) != DialogResult.Yes)
				{
					return;
				}
				if (Operators.ConditionalCompareObjectEqual(dataSet.Tables[0].Rows[0]["cin_no"], "หน\u0e49าฟร\u0e49อน", TextCompare: false))
				{
					DataSet dataSet2 = Module1.connect("select * from HT_CheckIn_Pay where pay_no='" + ListView1.SelectedItems[0].SubItems[1].Text + "'");
					...
					while (true)
					{
						...
						if (num3 <= num4)
						{
							Module1.connect(Conversions.ToString(Operators.ConcatenateObject(Operators.ConcatenateObject(Operators.ConcatenateObject(Operators.ConcatenateObject("update HT_Products set Pro_Amt=Pro_Amt+", dataSet2.Tables[0].Rows[num2]["cin_pay_ds_num"]), " where Pro_no='"), dataSet2.Tables[0].Rows[num2]["cin_pay_ds_id"]), "'")));
							num2++;
							continue;
						}
						break;
				...
				{
					Module1.connect("update HT_CheckIn_Pay set cin_status='ยกเล\u0e34ก' where pay_no='" + ListView1.SelectedItems[0].SubItems[1].Text + "'");
					DataSet dataSet3 = Module1.connect("select * from HT_CheckIn_Product where cin_no='" + ListView1.SelectedItems[0].SubItems[1].Text + "'");
					...
					while (true)
					{
						...
						Module1.connect(Conversions.ToString(Operators.ConcatenateObject(Operators.ConcatenateObject(Operators.ConcatenateObject(Operators.ConcatenateObject("update HT_Products set Pro_Amt=Pro_Amt+", dataSet3.Tables[0].Rows[num6]["cin_pro_num"]), " where Pro_no='"), dataSet3.Tables[0].Rows[num6]["cin_pro_id"]), "'")));
						num6++;
					}
				}
	...
	private void ButtonItem1_Click(object sender, EventArgs e)
	{
		...
		{
			Print_Report.Print_Sale(ListView1.SelectedItems[0].SubItems[1].Text, preview: false);
		}
	}
	...
	private void ListView1_SelectedIndexChanged(object sender, EventArgs e)
	{
		...
		ListView2.Items.Clear();
		DataSet dataSet = Module1.connect("select * from view_pay_ds where pay_no='" + ListView1.SelectedItems[0].SubItems[1].Text + "' order by cin_pay_ds_name");
		checked
		{
			...
			while (true)
			{
				...
				if (num3 <= num4)
				{
					...
					listView.Items[count].SubItems.Add(Strings.Format(RuntimeHelpers.GetObjectValue(dataSet.Tables[0].Rows[num2]["Cin_Pay_Ds_Price"]), "#,##0.00"));
					listView = null;
					num2++;
					continue;
				}
	...
	private void ButtonItem2_Click(object sender, EventArgs e)
	{
		...
		DataSet dataSet = Module1.connect("select * from HT_CheckIn_Pay where pay_no='" + ListView1.SelectedItems[0].SubItems[1].Text + "'");
		if (Operators.ConditionalCompareObjectEqual(dataSet.Tables[0].Rows[0]["Cin_Status"], "ยกเล\u0e34ก", TextCompare: false))
		{
			MessageBox.Show("รายการน\u0e35\u0e49ได\u0e49ยกเล\u0e34กไปแล\u0e49ว");
			return;
		}
		MyProject.Forms.FormEditPay.Label_price.Text = Strings.Format(Operators.AddObject(Operators.AddObject(Operators.AddObject(dataSet.Tables[0].Rows[0]["Cin_Pay_Cash"], dataSet.Tables[0].Rows[0]["Cin_Pay_Credit"]), dataSet.Tables[0].Rows[0]["Cin_Pay_Free"]), dataSet.Tables[0].Rows[0]["Cin_Pay_Tran"]), "#,##0.00");
		MyProject.Forms.FormEditPay.Label_num.Text = Conversions.ToString(dataSet.Tables[0].Rows[0]["Pay_no"]);
		MyProject.Forms.FormEditPay.TextBoxX_3.Text = Conversions.ToString(dataSet.Tables[0].Rows[0]["Cin_Pay_Cash"]);
		MyProject.Forms.FormEditPay.TextBoxX_2.Text = Conversions.ToString(dataSet.Tables[0].Rows[0]["Cin_Pay_Credit"]);
		MyProject.Forms.FormEditPay.TextBoxX_0.Text = Conversions.ToString(dataSet.Tables[0].Rows[0]["Cin_Pay_Free"]);
		MyProject.Forms.FormEditPay.TextBoxX_1.Text = Conversions.ToString(dataSet.Tables[0].Rows[0]["Cin_Pay_Tran"]);
		MyProject.Forms.FormEditPay.TextBoxX_4.Text = Conversions.ToString(dataSet.Tables[0].Rows[0]["Cin_Pay_web"]);
		MyProject.Forms.FormEditPay.ShowDialog();
		if (MyProject.Forms.FormEditPay.isok)
		{
			ListView1.SelectedItems[0].SubItems[4].Text = Strings.Format(Conversions.ToDecimal(MyProject.Forms.FormEditPay.TextBoxX_3.Text), "#,##0.00");
			ListView1.SelectedItems[0].SubItems[5].Text = Strings.Format(Conversions.ToDecimal(MyProject.Forms.FormEditPay.TextBoxX_2.Text), "#,##0.00");
			ListView1.SelectedItems[0].SubItems[6].Text = Strings.Format(Conversions.ToDecimal(MyProject.Forms.FormEditPay.TextBoxX_1.Text), "#,##0.00");
			ListView1.SelectedItems[0].SubItems[7].Text = Strings.Format(Conversions.ToDecimal(MyProject.Forms.FormEditPay.TextBoxX_0.Text), "#,##0.00");
			ListView1.SelectedItems[0].SubItems[8].Text = Strings.Format(Conversions.ToDecimal(MyProject.Forms.FormEditPay.TextBoxX_4.Text), "#,##0.00");
		}
	}
}
