...
[DesignerGenerated]
public class FormSearchChechInnotOut : Office2007Form
{
	...
	[DebuggerNonUserCode]
	static FormSearchChechInnotOut()
	{
		Class2.LH6iGfYz9j3MJ();
		__ENCList = new List<WeakReference>();
	}

	public FormSearchChechInnotOut()
	{
		Class2.LH6iGfYz9j3MJ();
	...
	private void InitializeComponent()
	{
		...
		size = new System.Drawing.Size(982, 492);
		listView2.Size = size;
		...
		this.ColumnHeader3.Text = "ช\u0e37\u0e48อผ\u0e39\u0e49เข\u0e49าพ\u0e31ก";
		this.ColumnHeader3.Width = 200;
		this.ColumnHeader5.Text = "เบอร\u0e4cโทร";
		this.ColumnHeader5.Width = 100;
		this.ColumnHeader4.Text = "ห\u0e49องพ\u0e31ก";
		...
		location = new System.Drawing.Point(931, 539);
		...
		size = new System.Drawing.Size(1011, 574);
		...
		this.Margin = margin;
		this.Name = "FormSearchChechInnotOut";
		this.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen;
		this.Text = "ค\u0e49นหารายการเข\u0e49าพ\u0e31กท\u0e35\u0e48ย\u0e31งไม\u0e48 Check-Out";
		this.TopMost = true;
	...
	public void Search()
	{
		object obj = " where Cin_no<>'' ";
		if (Operators.CompareString(TextBox1.Text, "", TextCompare: false) != 0)
		{
			obj = Operators.ConcatenateObject(obj, string.Concat(" and Cin_no like '%" + TextBox1.Text, "%'"));
		}
		if (Operators.CompareString(TextBox2.Text, "", TextCompare: false) != 0)
		{
			obj = Operators.ConcatenateObject(obj, string.Concat(" and cust_name like '%" + TextBox2.Text, "%'"));
		}
		DataSet dataSet = Module1.connect(Conversions.ToString(Operators.ConcatenateObject(Operators.ConcatenateObject("select top 200 * from View_Check_Out ", obj), " and cin_status='ปกต\u0e34' order by Cin_no desc")));
		...
		checked
		{
			...
			while (true)
			{
				...
				if (num3 <= num4)
				{
					...
					if (Operators.ConditionalCompareObjectEqual(dataSet.Tables[0].Rows[num2]["checkout"], 0, TextCompare: false))
					{
						listView.Items[num2].SubItems.Add("ย\u0e31งไม\u0e48ได\u0e49 Check-Out");
						listView.Items[num2].BackColor = Color.LightPink;
					}
					else if (Operators.ConditionalCompareObjectNotEqual(dataSet.Tables[0].Rows[num2]["checkout"], dataSet.Tables[0].Rows[num2]["RoomALL"], TextCompare: false))
					{
						listView.Items[num2].SubItems.Add("Check-Out ย\u0e31งไม\u0e48ครบ");
						listView.Items[num2].BackColor = Color.Yellow;
					}
					else
					{
						listView.Items[num2].SubItems.Add("Check-Out เร\u0e35ยบร\u0e49อย");
