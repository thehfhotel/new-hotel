...
public class CrystalReportDaysContenue : ReportClass
{
	...
	public override string ResourceName
	{
		get
		{
			return "CrystalReportDaysContenue.rpt";
		}
		set
		{
		}
	...
	public override string FullResourceName
	{
		get
		{
			return "iHOTEL2025.CrystalReportDaysContenue.rpt";
		}
		set
		{
		}
	...
	[DebuggerNonUserCode]
	static CrystalReportDaysContenue()
	{
		Class2.LH6iGfYz9j3MJ();
		__ENCList = new List<WeakReference>();
	}

	public CrystalReportDaysContenue()
	{
		Class2.LH6iGfYz9j3MJ();
