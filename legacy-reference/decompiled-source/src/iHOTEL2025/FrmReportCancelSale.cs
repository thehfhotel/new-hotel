...
[DesignerGenerated]
public class FrmReportCancelSale : Office2007Form
{
	...
	private void InitializeComponent()
	{
		...
		this.GroupBox1.Text = "รายงานการยกเล\u0e34กการขายส\u0e34นค\u0e49า";
		...
		this.ListView1.Columns.AddRange(new System.Windows.Forms.ColumnHeader[6] { this.ColumnHeader1, this.ColumnHeader3, this.ColumnHeader4, this.ColumnHeader8, this.ColumnHeader2, this.ColumnHeader7 });
		...
		this.ColumnHeader3.Text = "เลขท\u0e35\u0e48บ\u0e34ล";
		...
		this.Margin = margin;
		this.Name = "FrmReportCancelSale";
		this.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen;
		this.Text = "รายงานการยกเล\u0e34กการขายส\u0e34นค\u0e49า";
	...
	public void search()
	{
		object left = "SELECT * from View_Bill_Cancel";
