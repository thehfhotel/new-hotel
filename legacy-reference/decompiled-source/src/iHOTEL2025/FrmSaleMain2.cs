...
[DesignerGenerated]
public class FrmSaleMain2 : Office2007Form
{
	...
	private void InitializeComponent()
	{
		...
		System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(iHOTEL2025.FrmSaleMain2));
		...
		this.PanelEx1.Text = "รายการขายส\u0e34นค\u0e49า  |";
		...
		this.ItemContainer1.SubItems.AddRange(new DevComponents.DotNetBar.BaseItem[3] { this.ButtonAdd, this.ButtonCancel, this.ButtonItem1 });
		...
		this.ButtonAdd.Tooltip = "เพ\u0e34\u0e48มรายการขาย";
		...
		location = new System.Drawing.Point(625, 225);
		...
		location = new System.Drawing.Point(55, 23);
		...
		this.ListView2.Columns.AddRange(new System.Windows.Forms.ColumnHeader[5] { this.ColumnHeader6, this.ColumnHeader8, this.ColumnHeader18, this.ColumnHeader7, this.ColumnHeader9 });
		...
		size = new System.Drawing.Size(862, 160);
		listView3.Size = size;
		...
		this.ColumnHeader18.Text = "จำนวน";
		this.ColumnHeader18.TextAlign = System.Windows.Forms.HorizontalAlignment.Right;
		this.ColumnHeader18.Width = 100;
		this.ListView1.Anchor = System.Windows.Forms.AnchorStyles.Top | System.Windows.Forms.AnchorStyles.Bottom | System.Windows.Forms.AnchorStyles.Left | System.Windows.Forms.AnchorStyles.Right;
		this.ListView1.Columns.AddRange(new System.Windows.Forms.ColumnHeader[10] { this.ColumnHeader4, this.ColumnHeader12, this.ColumnHeader13, this.ColumnHeader14, this.ColumnHeader10, this.ColumnHeader11, this.ColumnHeader1, this.ColumnHeader2, this.ColumnHeader3, this.ColumnHeader5 });
		...
		size = new System.Drawing.Size(862, 126);
		listView6.Size = size;
		...
		this.ColumnHeader9.Text = "ราคารวม";
		this.ColumnHeader9.TextAlign = System.Windows.Forms.HorizontalAlignment.Right;
		this.ColumnHeader9.Width = 100;
		this.ColumnHeader10.Text = "ท\u0e35\u0e48อย\u0e39\u0e48";
		this.ColumnHeader10.Width = 200;
		this.ColumnHeader11.Text = "โทร";
		...
		margin = new System.Windows.Forms.Padding(3, 4, 3, 4);
		this.Margin = margin;
		this.Name = "FrmSaleMain2";
		this.StartPosition = System.Windows.Forms.FormStartPosition.CenterParent;
		this.Text = "รายการขายส\u0e34นค\u0e49า";
	...
	{
		Cursor = Cursors.WaitCursor;
		object left = "select * from HT_Bill_Debt_H where Bill_No<>''";
		if (Operators.CompareString(TextBox_0.Text, "", TextCompare: false) != 0)
		{
			left = Operators.ConcatenateObject(left, string.Concat(" and Bill_No like '%" + TextBox_0.Text, "%'"));
		}
		if (Operators.CompareString(Tcustname.Text, "", TextCompare: false) != 0)
		{
			left = Operators.ConcatenateObject(left, string.Concat(" and Bill_Cust_Name like '%" + Tcustname.Text, "%'"));
		}
		if (checkbox1.Checked)
		{
			left = Operators.ConcatenateObject(left, string.Concat(string.Concat(string.Concat(" and (Bill_Date between '" + Conversions.ToString(DateTimePicker1.Value.Date), " 00:00:00' and '"), Conversions.ToString(DateTimePicker2.Value.Date)), " 23:59:59')"));
		}
		left = Operators.ConcatenateObject(left, "  order by Bill_No desc");
		...
		checked
		{
			...
			while (true)
			{
				...
				ListView1.Items[count].SubItems.Add(dataSet.Tables[0].Rows[num3]["Bill_No"].ToString());
				ListView1.Items[count].SubItems.Add(Strings.Format(RuntimeHelpers.GetObjectValue(dataSet.Tables[0].Rows[num3]["Bill_Date"]), "dd/MM/yyyy HH:mm"));
				...
				string columnName = "Bill_Cust_Name";
				...
				ListView1.Items[count].SubItems.Add(Strings.Format(RuntimeHelpers.GetObjectValue(dataSet.Tables[0].Rows[num3]["Bill_Total"]), "#,##0.00"));
				ListView1.Items[count].SubItems.Add(dataSet.Tables[0].Rows[num3]["Bill_Status"].ToString());
				...
				if (Operators.CompareString(dataSet.Tables[0].Rows[num3]["Bill_Status"].ToString(), "ยกเล\u0e34ก", TextCompare: false) == 0)
				{
				...
				{
					num = Conversions.ToDecimal(Operators.AddObject(num, dataSet.Tables[0].Rows[num3]["Bill_Total"]));
				}
				ListView1.Items[count].SubItems.Add(dataSet.Tables[0].Rows[num3]["Bill_by"].ToString());
				num3++;
			}
	...
	private void ButtonCancel_Click(object sender, EventArgs e)
	{
		...
		{
			MessageBox.Show("กร\u0e38ณาเล\u0e37อกรายการใบเสร\u0e47จร\u0e31บเง\u0e34น");
			return;
		}
		DataSet dataSet = Module1.connect("select * from HT_Bill_Debt_H where Bill_No='" + ListView1.SelectedItems[0].SubItems[1].Text + "'");
		checked
		{
			if (Operators.ConditionalCompareObjectEqual(dataSet.Tables[0].Rows[0]["Bill_Status"], "ยกเล\u0e34ก", TextCompare: false))
			{
				MessageBox.Show("รายการน\u0e35\u0e49ได\u0e49ยกเล\u0e34กไปแล\u0e49ว");
			}
			else
			{
				if (MessageBox.Show("ค\u0e38ณต\u0e49องการยกเล\u0e34กใบขายหร\u0e37อไม\u0e48", "ยกเล\u0e34กใบขายส\u0e34นค\u0e49า", MessageBoxButtons.YesNo, MessageBoxIcon.Asterisk) != DialogResult.Yes)
				{
					return;
				}
				...
				DataSet dataSet2 = Module1.connect("select * from HT_Bill_Debt_Ds where Bill_No='" + ListView1.SelectedItems[0].SubItems[1].Text + "'");
				...
				while (true)
				{
					...
					Module1.connect(Conversions.ToString(Operators.ConcatenateObject(Operators.ConcatenateObject(Operators.ConcatenateObject(Operators.ConcatenateObject("update HT_Products set Pro_Amt=Pro_Amt+", dataSet2.Tables[0].Rows[num2]["DS_NUM"]), " where Pro_no='"), dataSet2.Tables[0].Rows[num2]["DS_NO"]), "'")));
					num2++;
				}
				Module1.connect(Conversions.ToString(Operators.ConcatenateObject(Operators.ConcatenateObject(Operators.ConcatenateObject(Operators.ConcatenateObject("update HT_CheckIn_Pay set Cin_Pay_Cash=0, Cin_Pay_Credit=0, Cin_Pay_Free=0, Cin_Pay_Tran=0, Cin_Pay_web=0, Cin_Pay_note='ยกเล\u0e34ก โดย ", Module1.loginName), "', Cin_Status='3' where Cin_No='"), ListView1.SelectedItems[0].SubItems[1].Text), "'")));
				Module1.connect("update HT_Bill_Debt_H set Bill_Status='ยกเล\u0e34ก' where Bill_No='" + ListView1.SelectedItems[0].SubItems[1].Text + "'");
				Module1.SaveCancel("", ListView1.SelectedItems[0].SubItems[1].Text, Conversions.ToString(obj));
	...
	private void ButtonItem1_Click(object sender, EventArgs e)
	{
		...
		{
			Print_Report.Print_SaleCredit(ListView1.SelectedItems[0].SubItems[1].Text, preview: false);
		}
	}
	...
	private void ListView1_SelectedIndexChanged(object sender, EventArgs e)
	{
		...
		ListView2.Items.Clear();
		DataSet dataSet = Module1.connect("select * from HT_Bill_Debt_Ds where Bill_No='" + ListView1.SelectedItems[0].SubItems[1].Text + "' order by DS_ID");
		checked
		{
			...
			while (true)
			{
				...
				if (num3 <= num4)
				{
					...
					listView.Items[count].SubItems.Add(Strings.Format(RuntimeHelpers.GetObjectValue(dataSet.Tables[0].Rows[num2]["DS_PRICE"]), "#,##0.00"));
					listView.Items[count].SubItems.Add(Strings.Format(RuntimeHelpers.GetObjectValue(dataSet.Tables[0].Rows[num2]["DS_PRICE_TOTAL"]), "#,##0.00"));
					listView = null;
					num2++;
					continue;
				}
