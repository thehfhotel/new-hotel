...
[DesignerGenerated]
public class FrmPayAddPro : Office2007Form
{
	...
	private void InitializeComponent()
	{
		...
		System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(iHOTEL2025.FrmPayAddPro));
		...
		location = new System.Drawing.Point(1085, 74);
		...
		location = new System.Drawing.Point(1085, 36);
		...
		System.Windows.Forms.Label label3 = this.Label22;
		location = new System.Drawing.Point(1030, 12);
		label3.Location = location;
		this.Label22.Name = "Label22";
		System.Windows.Forms.Label label4 = this.Label22;
		...
		location = new System.Drawing.Point(833, 28);
		...
		location = new System.Drawing.Point(764, 31);
		...
		location = new System.Drawing.Point(619, 28);
		...
		location = new System.Drawing.Point(546, 30);
		...
		location = new System.Drawing.Point(619, 55);
		...
		location = new System.Drawing.Point(413, 28);
		...
		location = new System.Drawing.Point(378, 31);
		...
		System.Windows.Forms.Label label35 = this.Label6;
		location = new System.Drawing.Point(363, 62);
		label35.Location = location;
		this.Label6.Name = "Label6";
		System.Windows.Forms.Label label36 = this.Label6;
		size = new System.Drawing.Size(49, 16);
		label36.Size = size;
		...
		location = new System.Drawing.Point(803, 60);
		...
		location = new System.Drawing.Point(588, 60);
		...
		location = new System.Drawing.Point(413, 58);
		...
		location = new System.Drawing.Point(155, 730);
		...
		location = new System.Drawing.Point(22, 736);
		...
		size = new System.Drawing.Size(949, 238);
		grid2.Size = size;
		...
		System.Windows.Forms.Button button13 = this.Button9;
		location = new System.Drawing.Point(381, 461);
		button13.Location = location;
		System.Windows.Forms.Button button14 = this.Button9;
		margin = new System.Windows.Forms.Padding(3, 4, 3, 4);
		button14.Margin = margin;
		this.Button9.Name = "Button9";
		System.Windows.Forms.Button button15 = this.Button9;
		...
		System.Windows.Forms.Button button16 = this.Button5;
		location = new System.Drawing.Point(328, 461);
		button16.Location = location;
		System.Windows.Forms.Button button17 = this.Button5;
		margin = new System.Windows.Forms.Padding(3, 4, 3, 4);
		button17.Margin = margin;
		this.Button5.Name = "Button5";
		System.Windows.Forms.Button button18 = this.Button5;
		...
		System.Windows.Forms.Button button19 = this.Button7;
		location = new System.Drawing.Point(970, 709);
		button19.Location = location;
		System.Windows.Forms.Button button20 = this.Button7;
		margin = new System.Windows.Forms.Padding(3, 4, 3, 4);
		button20.Margin = margin;
		this.Button7.Name = "Button7";
		System.Windows.Forms.Button button21 = this.Button7;
		size = new System.Drawing.Size(235, 44);
		button21.Size = size;
		this.Button7.TabIndex = 3;
		this.Button7.Text = "          บ\u0e31นท\u0e36ก ค\u0e48าใช\u0e49จ\u0e48าย";
		...
		margin = new System.Windows.Forms.Padding(3, 4, 3, 4);
		this.Margin = margin;
		this.Name = "FrmPayAddPro";
		this.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen;
		this.Text = "ค\u0e48าใช\u0e49จ\u0e48ายอ\u0e37\u0e48นๆ";
	...
	public void SAVE_EDIT()
	{
		...
		checked
		{
			...
			while (true)
			{
				...
				num8 = decimal.Add(num8, Conversions.ToDecimal(Grid2[num10, 14]));
				...
				Module1.connect("update HT_Products set Pro_Amt=Pro_Amt-" + Conversions.ToString(Conversions.ToDecimal(Grid2[num10, 6])) + " where Pro_no='" + Conversions.ToString(Grid2[num10, 13]) + "'");
				num10++;
			}
			...
			Module1.connect(Conversions.ToString(obj));
			Module1.UPDATE_MONEY(text, num8, "DEL", "ต\u0e31ดจากใบลงทะเบ\u0e35ยน " + TdocNum.Text);
			object obj2 = "";
			if (decimal.Compare(num8, 0m) > 0)
			{
				...
				while (true)
				{
					...
					{
						num8 = decimal.Add(num8, Conversions.ToDecimal(Grid2[num23, 14]));
		...
		checked
		{
			...
			while (true)
			{
				...
				if (Operators.CompareString(Conversions.ToString(Grid2[num10, 1]), "", TextCompare: false) != 0)
				{
					...
					{
						decimal num13 = decimal.Subtract(Conversions.ToDecimal(Grid2[num10, 8]), Conversions.ToDecimal(Grid2[num10, 9]));
						if (decimal.Compare(num13, 0m) >= 0)
						{
							if (decimal.Compare(num13, num) == 0)
							{
								num12 = num;
								num = default(decimal);
							}
							else if (decimal.Compare(num13, num) > 0)
							{
								num12 = num;
								num = default(decimal);
							}
							...
							{
								num12 = num13;
								num = decimal.Subtract(num, num13);
							}
							Grid2[num10, 14] = num12;
							Grid2[num10, 10] = decimal.Subtract(decimal.Subtract(Conversions.ToDecimal(Grid2[num10, 8]), num12), Conversions.ToDecimal(Grid2[num10, 9]));
						}
					}
				}
				num10++;
