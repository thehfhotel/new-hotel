...
[DesignerGenerated]
public class FrmSETMyType2 : Office2007Form
{
	...
	[DebuggerNonUserCode]
	static FrmSETMyType2()
	{
		Class2.LH6iGfYz9j3MJ();
		__ENCList = new List<WeakReference>();
	}

	public FrmSETMyType2()
	{
		Class2.LH6iGfYz9j3MJ();
	...
	private void InitializeComponent()
	{
		...
		location = new System.Drawing.Point(14, 333);
		...
		size = new System.Drawing.Size(470, 298);
		listView2.Size = size;
		...
		this.ColumnHeader2.Text = "ช\u0e37\u0e48อหมวด";
		...
		location = new System.Drawing.Point(61, 330);
		...
		location = new System.Drawing.Point(226, 330);
		...
		this.PanelEx2.Text = "ต\u0e31\u0e49งค\u0e48าหมวด";
		...
		this.Name = "FrmSETMyType2";
		this.StartPosition = System.Windows.Forms.FormStartPosition.CenterParent;
		this.Text = "ต\u0e31\u0e49งค\u0e48าหมวด";
	...
	private void Button2_Click(object sender, EventArgs e)
	{
		...
		{
			if (Module1.connect("SELECT * From TB_SET_MyType2 where name like '" + TextBox1.Text + "'").Tables[0].Rows.Count != 0)
			{
			...
			{
				object obj = "";
				obj = "INSERT INTO [TB_SET_MyType2]";
		...
		{
			Module1.connect(string.Format("Update TB_SET_MyType2 SET name = '{0}',id_full='{2}' WHERE id={1}", TextBox1.Text, OLD_ID, TextBox2.Text));
	...
	public void DEL_item()
	{
		...
		{
			DataSet dataSet = Module1.connect("select * from TB_SET_MyType2_2 where id_full like '" + ListView1.SelectedItems[0].SubItems[1].Text + "%'");
			if (dataSet.Tables[0].Rows.Count != 0)
			{
				MessageBox.Show("รห\u0e31ส " + ListView1.SelectedItems[0].SubItems[1].Text + " ไม\u0e48สามารถลบได\u0e49เน\u0e37\u0e48องจากรห\u0e31สประเภทย\u0e31งไม\u0e48ได\u0e49ลบ");
			}
			...
			{
				Module1.connect("delete from TB_SET_MyType2 where id=" + ListView1.SelectedItems[0].SubItems[0].Text);
	...
	private void ToolStripMenuItem_1_Click(object sender, EventArgs e)
	{
		if (ListView1.SelectedItems.Count != 0)
		{
			DataSet dataSet = Module1.connect("select * from TB_SET_MyType2 where id_full like '" + ListView1.SelectedItems[0].SubItems[1].Text + "%'");
			if (dataSet.Tables[0].Rows.Count != 0)
			{
