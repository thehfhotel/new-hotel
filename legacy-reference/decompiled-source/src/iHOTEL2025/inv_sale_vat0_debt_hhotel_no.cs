...
public class inv_sale_vat0_debt_hhotel_no : ReportClass
{
	...
	public override string ResourceName
	{
		get
		{
			return "inv_sale_vat0_debt_hhotel_no.rpt";
		}
		set
		{
		}
	...
	public override string FullResourceName
	{
		get
		{
			return "iHOTEL2025.inv_sale_vat0_debt_hhotel_no.rpt";
		}
		set
		{
		}
	...
	[DebuggerNonUserCode]
	static inv_sale_vat0_debt_hhotel_no()
	{
		Class2.LH6iGfYz9j3MJ();
		__ENCList = new List<WeakReference>();
	}

	public inv_sale_vat0_debt_hhotel_no()
	{
		Class2.LH6iGfYz9j3MJ();
