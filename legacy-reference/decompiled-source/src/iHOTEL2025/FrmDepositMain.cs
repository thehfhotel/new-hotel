...
[DesignerGenerated]
public class FrmDepositMain : Office2007Form
{
	...
	private void InitializeComponent()
	{
		...
		System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(iHOTEL2025.FrmDepositMain));
		...
		this.PanelEx1.Text = "ใบม\u0e31ดจำห\u0e49องพ\u0e31ก  |";
		...
		this.ItemContainer1.SubItems.AddRange(new DevComponents.DotNetBar.BaseItem[2] { this.ButtonCancel, this.ButtonItem1 });
		...
		this.ButtonCancel.Text = "ค\u0e37นค\u0e48าม\u0e31ดจำ";
		...
		location = new System.Drawing.Point(48, 23);
		...
		this.Label2.Text = "เลขท\u0e35\u0e48ใบม\u0e31ดจำ :";
		...
		{
			this.ColumnHeader3, this.ColumnHeader4, this.ColumnHeader2, this.ColumnHeader12, this.ColumnHeader9, this.ColumnHeader13, this.ColumnHeader14, this.ColumnHeader1, this.ColumnHeader5, this.ColumnHeader6,
			this.ColumnHeader7
		});
		...
		this.ColumnHeader5.Text = "ผ\u0e39\u0e49ร\u0e31บเง\u0e34น";
		this.ColumnHeader5.Width = 100;
		this.ColumnHeader6.Text = "ว\u0e31นท\u0e35\u0e48ค\u0e37นเง\u0e34น";
	...
	public void Search()
	{
		...
		{
			left = Operators.ConcatenateObject(left, string.Concat(" and dep_no like '%" + TextBox_0.Text, "%'"));
		}
		...
		left = Operators.ConcatenateObject(left, " order by dep_no desc");
		...
		checked
		{
			...
			while (true)
			{
				...
				ListView1.Items[count].SubItems.Add(dataSet.Tables[0].Rows[num3]["dep_no"].ToString());
				ListView1.Items[count].SubItems.Add(dataSet.Tables[0].Rows[num3]["cust_name"].ToString());
				ListView1.Items[count].SubItems.Add(Strings.Format(RuntimeHelpers.GetObjectValue(dataSet.Tables[0].Rows[num3]["Cin_Date"]), "dd/MM/yyyy HH:mm"));
				...
				ListView1.Items[count].SubItems.Add(Strings.Format(RuntimeHelpers.GetObjectValue(dataSet.Tables[0].Rows[num3]["Cin_Room_Dep"]), "#,##0.00"));
				ListViewItem.ListViewSubItemCollection subItems2 = ListView1.Items[count].SubItems;
				array3 = new object[1];
				object[] array6 = array3;
				dataRow = dataSet.Tables[0].Rows[num3];
				DataRow dataRow4 = dataRow;
				columnName = "cin_Dep_Status";
				...
				if (Operators.CompareString(dataSet.Tables[0].Rows[num3]["cin_Dep_Status"].ToString(), "ยกเล\u0e34ก", TextCompare: false) == 0)
				{
					ListView1.Items[count].ForeColor = Color.White;
					ListView1.Items[count].BackColor = Color.Red;
				}
				else if (Operators.CompareString(dataSet.Tables[0].Rows[num3]["cin_Dep_Status"].ToString(), "ย\u0e31งไม\u0e48ค\u0e37นค\u0e48าม\u0e31ดจำ", TextCompare: false) == 0)
				{
					ListView1.Items[count].BackColor = Color.Yellow;
				}
				ListView1.Items[count].SubItems.Add(dataSet.Tables[0].Rows[num3]["Dep_by"].ToString());
				if (Operators.CompareString(dataSet.Tables[0].Rows[num3]["Cin_Dep_return_date"].ToString(), "", TextCompare: false) != 0)
				{
					ListView1.Items[count].SubItems.Add(Strings.Format(RuntimeHelpers.GetObjectValue(dataSet.Tables[0].Rows[num3]["Cin_Dep_return_date"]), "dd/MM/yyyy HH:mm"));
				}
				else
				{
					ListView1.Items[count].SubItems.Add("");
				}
				ListView1.Items[count].SubItems.Add(dataSet.Tables[0].Rows[num3]["Cin_Dep_return_by"].ToString());
				num3++;
			}
	...
	private void ButtonCancel_Click(object sender, EventArgs e)
	{
		...
		{
			MessageBox.Show("กร\u0e38ณาเล\u0e37อกรายการใบม\u0e31ดจำ");
			return;
		}
		DataSet dataSet = Module1.connect("select Cin_Dep_Status,Cin_Room_Dep from View_Deposit_H where id=" + ListView1.SelectedItems[0].SubItems[0].Text);
		if (Operators.CompareString(dataSet.Tables[0].Rows[0]["Cin_Dep_Status"].ToString(), "ยกเล\u0e34ก", TextCompare: false) == 0)
		{
			MessageBox.Show("รายการน\u0e35\u0e49ได\u0e49ยกเล\u0e34กไปแล\u0e49ว", "ค\u0e48าม\u0e31ดจำ", MessageBoxButtons.OK, MessageBoxIcon.Hand);
		}
		else if (Operators.CompareString(dataSet.Tables[0].Rows[0]["Cin_Dep_Status"].ToString(), "ค\u0e37นเง\u0e34นแล\u0e49ว", TextCompare: false) == 0)
		{
			MessageBox.Show("รายการน\u0e35\u0e49ได\u0e49ค\u0e37นเง\u0e34นไปแล\u0e49ว", "ค\u0e48าม\u0e31ดจำ", MessageBoxButtons.OK, MessageBoxIcon.Hand);
		}
		else if (MessageBox.Show("ค\u0e38ณต\u0e49องการค\u0e37นเง\u0e34นใบม\u0e31ดจำหร\u0e37อไม\u0e48", "ค\u0e37นเง\u0e34น", MessageBoxButtons.YesNo, MessageBoxIcon.Asterisk) == DialogResult.Yes)
		{
			Module1.connect(Conversions.ToString(Operators.ConcatenateObject(Operators.ConcatenateObject(Operators.ConcatenateObject("update HT_CheckIn_Ds set Cin_Dep_return_date=getdate(),Cin_Dep_Status='ค\u0e37นเง\u0e34นแล\u0e49ว',Cin_Dep_return_by='", Module1.loginName), "' where id="), ListView1.SelectedItems[0].SubItems[0].Text)));
			MessageBox.Show(Conversions.ToString(Operators.ConcatenateObject(Operators.ConcatenateObject("จำนวนท\u0e35\u0e48ต\u0e49องค\u0e37น ", dataSet.Tables[0].Rows[0]["Cin_Room_Dep"]), " บาท")));
			Search();
		}
	}
	...
	private void ButtonItem1_Click(object sender, EventArgs e)
	{
		...
		{
			Print_Report.Print_Dep_per(ListView1.SelectedItems[0].SubItems[2].Text, preview: false);
		}
	}
