...
[DesignerGenerated]
public class FrmAddBook : Office2007Form
{
	...
	internal virtual ComboBox Tc_tel
	{
		...
		set
		{
			...
			EventHandler value4 = Tc_tel_SelectedIndexChanged;
			if (_Tc_tel != null)
			{
				_Tc_tel.LostFocus -= value2;
				_Tc_tel.GotFocus -= value3;
				_Tc_tel.SelectedIndexChanged -= value4;
			}
			_Tc_tel = value;
			if (_Tc_tel != null)
			{
	...
	private void InitializeComponent()
	{
		...
		System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(iHOTEL2025.FrmAddBook));
		...
		location = new System.Drawing.Point(759, 25);
		...
		this.ComboSale.TabIndex = 66;
		this.Label5.AutoSize = true;
		System.Windows.Forms.Label label = this.Label5;
		location = new System.Drawing.Point(674, 29);
		...
		System.Windows.Forms.Label label3 = this.Label21;
		location = new System.Drawing.Point(55, 82);
		label3.Location = location;
		this.Label21.Name = "Label21";
		System.Windows.Forms.Label label4 = this.Label21;
		...
		location = new System.Drawing.Point(2, 47);
		...
		size = new System.Drawing.Size(425, 245);
		...
		size = new System.Drawing.Size(419, 240);
		listView2.Size = size;
		...
		location = new System.Drawing.Point(437, 652);
		...
		location = new System.Drawing.Point(151, 652);
		...
		size = new System.Drawing.Size(989, 467);
		grid2.Size = size;
		...
		this.Tdays.Font = new System.Drawing.Font("Times New Roman", 12f, System.Drawing.FontStyle.Bold);
		this.Tdays.ForeColor = System.Drawing.Color.Blue;
		System.Windows.Forms.TextBox tdays = this.Tdays;
		location = new System.Drawing.Point(286, 652);
		...
		System.Windows.Forms.Label label19 = this.Label2;
		location = new System.Drawing.Point(276, 615);
		label19.Location = location;
		this.Label2.Name = "Label2";
		System.Windows.Forms.Label label20 = this.Label2;
		...
		location = new System.Drawing.Point(924, 128);
		...
		location = new System.Drawing.Point(598, 631);
		...
		System.Windows.Forms.Label label31 = this.Label18;
		location = new System.Drawing.Point(182, 631);
		label31.Location = location;
		this.Label18.Name = "Label18";
		System.Windows.Forms.Label label32 = this.Label18;
		...
		location = new System.Drawing.Point(16, 652);
		...
		System.Windows.Forms.Label label33 = this.Label24;
		location = new System.Drawing.Point(26, 631);
		label33.Location = location;
		this.Label24.Name = "Label24";
		System.Windows.Forms.Label label34 = this.Label24;
		...
		size = new System.Drawing.Size(131, 24);
		button6.Size = size;
		this.Button3.TabIndex = 3;
		this.Button3.Text = "เล\u0e37อกประเภทห\u0e49อง";
	...
	public void SAVE_ADD()
	{
		...
		checked
		{
			...
			while (true)
			{
				...
				if (Operators.CompareString(Conversions.ToString(Grid1[num2, 1]), "", TextCompare: false) != 0)
				{
					if (Operators.ConditionalCompareObjectLess(Grid1[num2, 3], dateTime, TextCompare: false))
					{
						dateTime = Conversions.ToDate(Grid1[num2, 3]);
					}
					if (Operators.ConditionalCompareObjectGreater(Grid1[num2, 4], dateTime2, TextCompare: false))
					{
						dateTime2 = Conversions.ToDate(Grid1[num2, 4]);
					}
					if (num2 == 1)
					{
						dateTime = Conversions.ToDate(Grid1[num2, 3]);
			...
			while (true)
			{
				...
				if (Operators.CompareString(Conversions.ToString(Grid1[num6, 1]), "", TextCompare: false) != 0)
				{
					...
					while (true)
					{
						...
						bool flag = false;
						if (Operators.ConditionalCompareObjectEqual(NewLateBinding.LateIndexGet(arrayList[num9], new object[1] { 0 }, null), Conversions.ToString(Grid1[num6, 2]), TextCompare: false))
						{
							flag = true;
							NewLateBinding.LateIndexSetComplex(arrayList[num9], new object[2]
							{
								1,
								decimal.Add(Conversions.ToDecimal(NewLateBinding.LateIndexGet(arrayList[num9], new object[1] { 0 }, null)), 1m)
						...
						else if (!flag)
						{
							...
							{
								Conversions.ToString(Grid1[num6, 2]),
			...
			while (true)
			{
				...
				text2 = Conversions.ToString(Operators.ConcatenateObject(text2, Operators.ConcatenateObject(Operators.ConcatenateObject(Operators.ConcatenateObject(Operators.ConcatenateObject(NewLateBinding.LateIndexGet(arrayList[num12], new object[1] { 0 }, null), " "), NewLateBinding.LateIndexGet(arrayList[num12], new object[1] { 1 }, null)), " ห\u0e49อง"), "\r\n")));
				num12++;
			}
			string text3 = "";
			...
			while (true)
			{
				...
				if (Operators.CompareString(Conversions.ToString(Grid1[num15, 1]), "", TextCompare: false) != 0 && Operators.CompareString(Conversions.ToString(Grid1[num15, 9]), "", TextCompare: false) != 0)
				{
					text3 = text3 + " " + Conversions.ToString(Grid1[num15, 9]);
				}
				num15++;
			}
			TdocNum.Text = GET_DOC();
			...
			left = Operators.ConcatenateObject(left, "," + Conversions.ToString(Conversions.ToDecimal(Tdays.Text)));
	...
	private void Button3_Click(object sender, EventArgs e)
	{
		...
		checked
		{
			...
			FormSearchRooms2 formSearchRooms = new FormSearchRooms2();
			formSearchRooms.D1 = Tstart.Value;
			formSearchRooms.D2 = Tend.Value;
			formSearchRooms.D3 = Conversions.ToInteger(Tnum.Text);
			formSearchRooms.USEROOM = 0;
			formSearchRooms.Room = arrayList;
			formSearchRooms.ShowDialog();
			if (!Operators.ConditionalCompareObjectNotEqual(formSearchRooms.SelectNO, "", TextCompare: false))
			{
				return;
			}
			int num5 = 1;
			...
			DataSet dataSet = Module1.connect(Conversions.ToString(Operators.ConcatenateObject(Operators.ConcatenateObject(Operators.ConcatenateObject(Operators.ConcatenateObject("select * from HT_Rooms_Price where room_type='", formSearchRooms.SelectNO), "' and room_custType='"), TCusType.Text), "' ")));
			int dN = formSearchRooms.DN;
			Grid1[num5, 1] = num5;
			Grid1[num5, 2] = RuntimeHelpers.GetObjectValue(formSearchRooms.SelectNO);
			...
			Grid1[num5, 7] = dN;
			Grid1[num5, 8] = Strings.Format(Operators.MultiplyObject(Operators.MultiplyObject(Conversions.ToDecimal(Tnum.Text), dataSet.Tables[0].Rows[0]["room_price"]), dN), "#,##0.00");
			Grid1[num5, 9] = "";
			num5++;
