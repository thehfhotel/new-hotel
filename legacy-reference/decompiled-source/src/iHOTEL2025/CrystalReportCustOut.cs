...
public class CrystalReportCustOut : ReportClass
{
	...
	public override string ResourceName
	{
		get
		{
			return "CrystalReportCustOut.rpt";
		}
		set
		{
		}
	...
	public override string FullResourceName
	{
		get
		{
			return "iHOTEL2025.CrystalReportCustOut.rpt";
		}
		set
		{
		}
	...
	[DebuggerNonUserCode]
	static CrystalReportCustOut()
	{
		Class2.LH6iGfYz9j3MJ();
		__ENCList = new List<WeakReference>();
	}

	public CrystalReportCustOut()
	{
		Class2.LH6iGfYz9j3MJ();
