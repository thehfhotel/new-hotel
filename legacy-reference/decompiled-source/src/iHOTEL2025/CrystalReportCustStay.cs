...
public class CrystalReportCustStay : ReportClass
{
	...
	public override string ResourceName
	{
		get
		{
			return "CrystalReportCustStay.rpt";
		}
		set
		{
		}
	...
	public override string FullResourceName
	{
		get
		{
			return "iHOTEL2025.CrystalReportCustStay.rpt";
		}
		set
		{
		}
	...
	[DebuggerNonUserCode]
	static CrystalReportCustStay()
	{
		Class2.LH6iGfYz9j3MJ();
		__ENCList = new List<WeakReference>();
	}

	public CrystalReportCustStay()
	{
		Class2.LH6iGfYz9j3MJ();
