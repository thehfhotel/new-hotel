...
[DesignerGenerated]
public class FormSearchBooking2 : Office2007Form
{
	...
	[DebuggerNonUserCode]
	static FormSearchBooking2()
	{
		Class2.LH6iGfYz9j3MJ();
		__ENCList = new List<WeakReference>();
	}

	public FormSearchBooking2()
	{
		Class2.LH6iGfYz9j3MJ();
	...
	private void InitializeComponent()
	{
		...
		this.ListView1.Columns.AddRange(new System.Windows.Forms.ColumnHeader[7] { this.ColumnHeader1, this.ColumnHeader2, this.ColumnHeader6, this.ColumnHeader7, this.ColumnHeader3, this.ColumnHeader5, this.ColumnHeader4 });
		...
		size = new System.Drawing.Size(819, 404);
		listView2.Size = size;
		...
		location = new System.Drawing.Point(768, 451);
		...
		this.ColumnHeader7.Text = "ว\u0e31นท\u0e35\u0e48เข\u0e49าพ\u0e31ก";
		this.ColumnHeader7.Width = 150;
		System.Drawing.SizeF sizeF = new System.Drawing.SizeF(7f, 16f);
		this.AutoScaleDimensions = sizeF;
		this.AutoScaleMode = System.Windows.Forms.AutoScaleMode.Font;
		size = new System.Drawing.Size(848, 486);
	...
	public void Search()
	{
		...
		DataSet dataSet = Module1.connect(Conversions.ToString(Operators.ConcatenateObject(Operators.ConcatenateObject("select * from HT_Book_H2 ", right), " and book_status='จอง' order by Book_ID desc")));
		...
		checked
		{
			...
			while (true)
			{
				...
				if (num3 <= num4)
				{
					...
					listView.Items[num2].SubItems.Add(Strings.Format(RuntimeHelpers.GetObjectValue(dataSet.Tables[0].Rows[num2]["Book_Date_in"]), "dd/MM/yy") + " - " + Strings.Format(RuntimeHelpers.GetObjectValue(dataSet.Tables[0].Rows[num2]["Book_Date_out"]), "dd/MM/yy"));
