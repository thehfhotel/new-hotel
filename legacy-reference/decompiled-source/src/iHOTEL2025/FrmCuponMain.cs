...
[DesignerGenerated]
public class FrmCuponMain : Office2007Form
{
	...
	private void InitializeComponent()
	{
		...
		this.ButtonItem1.Text = "พ\u0e34มพ\u0e4c\rค\u0e39ปอง";
		...
		this.ListView1.Columns.AddRange(new System.Windows.Forms.ColumnHeader[9] { this.ColumnHeader3, this.ColumnHeader4, this.ColumnHeader2, this.ColumnHeader13, this.ColumnHeader12, this.ColumnHeader6, this.ColumnHeader9, this.ColumnHeader5, this.ColumnHeader1 });
		...
		margin = new System.Windows.Forms.Padding(3, 4, 3, 4);
		this.Margin = margin;
		this.Name = "FrmCuponMain";
		this.StartPosition = System.Windows.Forms.FormStartPosition.CenterParent;
		this.Text = "ค\u0e39ปองอาหาร";
	...
	public void Search()
	{
		...
		{
			left = Operators.ConcatenateObject(left, string.Concat(" and cupon_no like '%" + TextBox_0.Text, "%'"));
		}
		...
		left = Operators.ConcatenateObject(left, " order by cupon_cin_room,cupon_no desc");
	...
	private void ButtonItem1_Click(object sender, EventArgs e)
	{
		...
		{
			MessageBox.Show("กร\u0e38ณาเล\u0e37อกใบค\u0e39ปอง");
			return;
		}
		checked
		{
			if (ListView1.CheckedItems.Count == 0)
			{
				if (ListView1.SelectedItems.Count != 0)
				{
					...
					arrayList.Add(ListView1.SelectedItems[0].SubItems[0].Text);
					Print_Report.Print_coupon(arrayList);
				}
			}
			else
			{
				...
				while (true)
				{
					...
					arrayList2.Add(ListView1.CheckedItems[num2].SubItems[0].Text);
					num2++;
				}
				Print_Report.Print_coupon(arrayList2);
			}
			Search();
		}
	}
