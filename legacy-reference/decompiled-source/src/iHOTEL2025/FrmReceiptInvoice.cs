...
[DesignerGenerated]
public class FrmReceiptInvoice : Office2007Form
{
	...
	private void InitializeComponent()
	{
		...
		System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(iHOTEL2025.FrmReceiptInvoice));
		...
		location = new System.Drawing.Point(40, 23);
		...
		{
			this.ColumnHeader3, this.ColumnHeader4, this.ColumnHeader9, this.ColumnHeader12, this.ColumnHeader13, this.ColumnHeader14, this.ColumnHeader1, this.ColumnHeader20, this.ColumnHeader19, this.ColumnHeader2,
			this.ColumnHeader16
		});
		...
		margin = new System.Windows.Forms.Padding(3, 4, 3, 4);
		this.Margin = margin;
		this.Name = "FrmReceiptInvoice";
		this.StartPosition = System.Windows.Forms.FormStartPosition.CenterParent;
		this.Text = "ใบแจ\u0e49งหน\u0e35\u0e49";
	...
	private void ButtonAdd_Click(object sender, EventArgs e)
	{
		...
		MyProject.Forms.FrmAddInvoiceSale.IEdit = (string)(object)0;
		MyProject.Forms.FrmAddInvoiceSale.clear();
		MyProject.Forms.FrmAddInvoiceSale.ShowDialog();
		Search();
	...
	{
		Cursor = Cursors.WaitCursor;
		object left = "select * from HT_Invoice_H where id<>0";
		...
		checked
		{
			...
			while (true)
			{
				...
				ListView1.Items[count].SubItems.Add("ใบแจ\u0e49งหน\u0e35\u0e49");
	...
	private void ButtonCancel_Click(object sender, EventArgs e)
	{
		...
		{
			MessageBox.Show("กร\u0e38ณาเล\u0e37อกรายการใบแจ\u0e49งหน\u0e35\u0e49");
			return;
		}
		DataSet dataSet = Module1.connect("select status_name from HT_Invoice_H where id=" + ListView1.SelectedItems[0].SubItems[0].Text);
		...
		else if (MessageBox.Show("ค\u0e38ณต\u0e49องการยกเล\u0e34กใบแจ\u0e49งหน\u0e35\u0e49หร\u0e37อไม\u0e48", "ยกเล\u0e34กใบแจเงหน\u0e35\u0e49", MessageBoxButtons.YesNo, MessageBoxIcon.Asterisk) == DialogResult.Yes)
		{
			Module1.connect("update HT_Invoice_H set status_name='ยกเล\u0e34ก' where id=" + ListView1.SelectedItems[0].SubItems[0].Text);
	...
	private void ButtonItem1_Click(object sender, EventArgs e)
	{
		...
		{
			Print_Report.Print_INVVat(Conversions.ToInteger(ListView1.SelectedItems[0].SubItems[0].Text), preview: false);
		}
	}
	...
	private void ButtonItem2_Click(object sender, EventArgs e)
	{
		...
		if (Operators.ConditionalCompareObjectEqual(dataSet.Tables[0].Rows[0]["status_name"], "ยกเล\u0e34ก", TextCompare: false))
		{
			MessageBox.Show("รายการใบแจ\u0e49งหน\u0e35\u0e49น\u0e35\u0e49ได\u0e49ยกเล\u0e34กไปแล\u0e49ว");
			return;
		}
		Cursor = Cursors.WaitCursor;
		MyProject.Forms.FrmAddInvoiceSale.clear();
		MyProject.Forms.FrmAddInvoiceSale.IEdit = ListView1.SelectedItems[0].SubItems[0].Text;
		MyProject.Forms.FrmAddInvoiceSale.clear();
		MyProject.Forms.FrmAddInvoiceSale.ShowDialog();
		Search();
		Cursor = Cursors.Default;
	...
	private void ListView1_SelectedIndexChanged(object sender, EventArgs e)
	{
		...
		ListView2.Items.Clear();
		DataSet dataSet = Module1.connect("select * from HT_Invoice_Ds where S_Sale_id=" + ListView1.SelectedItems[0].SubItems[0].Text + " order by id");
		checked
		{
