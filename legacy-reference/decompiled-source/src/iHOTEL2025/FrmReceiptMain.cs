...
[DesignerGenerated]
public class FrmReceiptMain : Office2007Form
{
	...
	private void InitializeComponent()
	{
		...
		System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(iHOTEL2025.FrmReceiptMain));
		...
		System.Drawing.Size size = new System.Drawing.Size(1220, 24);
		panelEx3.Size = size;
		...
		this.PanelEx1.Text = "ใบกำก\u0e31บภาษ\u0e35  |";
		...
		this.ButtonAdd.Tooltip = "เพ\u0e34\u0e48มใบเสร\u0e47จ";
		...
		size = new System.Drawing.Size(1129, 420);
		panelEx6.Size = size;
		...
		size = new System.Drawing.Size(1118, 85);
		groupBox4.Size = size;
		...
		location = new System.Drawing.Point(281, 24);
		...
		this.Label4.Text = "ประเภทบ\u0e34ล :";
		this.ComboType.DropDownStyle = System.Windows.Forms.ComboBoxStyle.DropDownList;
		this.ComboType.FormattingEnabled = true;
		this.ComboType.Items.AddRange(new object[4] { "ท\u0e31\u0e49งหมด", "ใบกำก\u0e31บภาษ\u0e35", "ใบกำก\u0e31บภาษ\u0e35อย\u0e48างย\u0e48อ", "บ\u0e34ลเง\u0e34นสด/ใบเสร\u0e47จร\u0e31บเง\u0e34น" });
		System.Windows.Forms.ComboBox comboType = this.ComboType;
		location = new System.Drawing.Point(361, 20);
		comboType.Location = location;
		this.ComboType.Name = "ComboType";
		System.Windows.Forms.ComboBox comboType2 = this.ComboType;
		size = new System.Drawing.Size(119, 24);
		comboType2.Size = size;
		this.ComboType.TabIndex = 92;
		System.Windows.Forms.DateTimePicker dateTimePicker = this.DateTimePicker2;
		location = new System.Drawing.Point(549, 48);
		...
		location = new System.Drawing.Point(549, 22);
		...
		location = new System.Drawing.Point(493, 23);
		...
		location = new System.Drawing.Point(496, 51);
		...
		location = new System.Drawing.Point(705, 22);
		...
		this.ListView2.Columns.AddRange(new System.Windows.Forms.ColumnHeader[9] { this.ColumnHeader5, this.ColumnHeader6, this.ColumnHeader7, this.ColumnHeader8, this.ColumnHeader10, this.ColumnHeader11, this.ColumnHeader17, this.ColumnHeader15, this.ColumnHeader18 });
		...
		size = new System.Drawing.Size(1118, 160);
		listView3.Size = size;
		...
		this.ColumnHeader7.Text = "รห\u0e31สส\u0e34นค\u0e49า";
		...
		this.ColumnHeader11.Text = "หน\u0e48วย";
		...
		this.ColumnHeader15.Text = "ส\u0e48วนลด";
		...
		{
			this.ColumnHeader3, this.ColumnHeader4, this.ColumnHeader9, this.ColumnHeader12, this.ColumnHeader21, this.ColumnHeader13, this.ColumnHeader14, this.ColumnHeader1, this.ColumnHeader20, this.ColumnHeader19,
			this.ColumnHeader2, this.ColumnHeader16
		});
		...
		size = new System.Drawing.Size(1118, 126);
		listView6.Size = size;
		...
		this.ColumnHeader9.Text = "ประเภท";
		this.ColumnHeader9.Width = 130;
		this.ColumnHeader12.Text = "เลขท\u0e35\u0e48ใบขาย";
		...
		this.ColumnHeader16.Text = "หมายเหต\u0e38";
		this.ColumnHeader16.Width = 300;
		this.ColumnHeader21.Text = "เลขอ\u0e49างอ\u0e34ง";
		this.ColumnHeader21.Width = 95;
		System.Drawing.SizeF sizeF = new System.Drawing.SizeF(7f, 16f);
		this.AutoScaleDimensions = sizeF;
		this.AutoScaleMode = System.Windows.Forms.AutoScaleMode.Font;
		size = new System.Drawing.Size(1220, 444);
	...
	{
		Cursor = Cursors.WaitCursor;
		object left = "select * from HT_Receipt_H where id<>0";
		if (Operators.CompareString(TextBox_0.Text, "", TextCompare: false) != 0)
		{
			left = Operators.ConcatenateObject(left, string.Concat(" and Receipt_no like '%" + TextBox_0.Text, "%'"));
		}
		if (Operators.CompareString(Tcustname.Text, "", TextCompare: false) != 0)
		{
			left = Operators.ConcatenateObject(left, string.Concat(" and Receipt_Name like '%" + Tcustname.Text, "%'"));
		}
		if (ComboType.SelectedIndex != 0)
		{
			if (ComboType.SelectedIndex == 1)
			{
				left = Operators.ConcatenateObject(left, " and Receipt_no like 'B%'");
			}
			else if (ComboType.SelectedIndex == 2)
			{
				left = Operators.ConcatenateObject(left, " and Receipt_no like 'SB%'");
			}
			else if (ComboType.SelectedIndex == 3)
			{
				left = Operators.ConcatenateObject(left, " and Receipt_no like 'CB%'");
			}
		}
		if (checkbox1.Checked)
		{
			left = Operators.ConcatenateObject(left, string.Concat(string.Concat(string.Concat(" and (Receipt_Date between '" + Conversions.ToString(DateTimePicker1.Value.Date), " 00:00:00' and '"), Conversions.ToString(DateTimePicker2.Value.Date)), " 23:59:59')"));
		}
		left = Operators.ConcatenateObject(left, " order by id desc");
		...
		checked
		{
			...
			while (true)
			{
				...
				if (dataSet.Tables[0].Rows[num3]["Receipt_no"].ToString().IndexOf("B") == 0)
				{
					ListView1.Items[count].SubItems.Add("ใบกำก\u0e31บภาษ\u0e35");
				}
				else if (dataSet.Tables[0].Rows[num3]["Receipt_no"].ToString().IndexOf("SB") == 0)
				{
					ListView1.Items[count].SubItems.Add("ใบกำก\u0e31บภาษ\u0e35อย\u0e48างย\u0e48อ");
				}
				else if (dataSet.Tables[0].Rows[num3]["Receipt_no"].ToString().IndexOf("CB") == 0)
				{
					ListView1.Items[count].SubItems.Add("บ\u0e34ลเง\u0e34นสด/ใบเสร\u0e47จร\u0e31บเง\u0e34น");
				}
				ListView1.Items[count].SubItems.Add(dataSet.Tables[0].Rows[num3]["Receipt_no"].ToString());
				ListView1.Items[count].SubItems.Add(dataSet.Tables[0].Rows[num3]["Receipt_ref"].ToString());
				ListView1.Items[count].SubItems.Add(Strings.Format(RuntimeHelpers.GetObjectValue(dataSet.Tables[0].Rows[num3]["Receipt_Date"]), "dd/MM/yyyy HH:mm:ss"));
				...
				ListView1.Items[count].SubItems.Add(Strings.Format(RuntimeHelpers.GetObjectValue(dataSet.Tables[0].Rows[num3]["Receipt_Total"]), "#,##0.00"));
				ListView1.Items[count].SubItems.Add(Strings.Format(RuntimeHelpers.GetObjectValue(dataSet.Tables[0].Rows[num3]["Receipt_Vat"]), "#,##0.00"));
				ListView1.Items[count].SubItems.Add(Strings.Format(RuntimeHelpers.GetObjectValue(dataSet.Tables[0].Rows[num3]["Receipt_BeforeVat"]), "#,##0.00"));
				...
				ListView1.Items[count].SubItems.Add(dataSet.Tables[0].Rows[num3]["Receipt_note"].ToString());
				if (Operators.ConditionalCompareObjectEqual(dataSet.Tables[0].Rows[num3]["status_name"], "ยกเล\u0e34ก", TextCompare: false))
				{
				...
				{
					num = Conversions.ToDecimal(Operators.AddObject(num, dataSet.Tables[0].Rows[num3]["Receipt_Total"]));
				}
				num3++;
			}
	...
	private void ButtonCancel_Click(object sender, EventArgs e)
	{
		...
		{
			MessageBox.Show("กร\u0e38ณาเล\u0e37อกรายการใบกำก\u0e31บภาษ\u0e35");
			return;
		}
		DataSet dataSet = Module1.connect("select status_name from HT_Receipt_H where id=" + ListView1.SelectedItems[0].SubItems[0].Text);
		...
		else if (MessageBox.Show("ค\u0e38ณต\u0e49องการยกเล\u0e34กใบขายหร\u0e37อไม\u0e48", "ยกเล\u0e34กใบขาย", MessageBoxButtons.YesNo, MessageBoxIcon.Asterisk) == DialogResult.Yes)
		{
			DataSet dataSet2 = Module1.connect("select * from HT_Receipt_H where id=" + ListView1.SelectedItems[0].SubItems[0].Text);
			Module1.connect(Conversions.ToString(Operators.ConcatenateObject(Operators.ConcatenateObject("update HT_CheckIn_Pay set cin_status='ยกเล\u0e34ก' where cin_no='", dataSet2.Tables[0].Rows[0]["Receipt_no"]), "' ")));
			Module1.connect(Conversions.ToString(Operators.ConcatenateObject(Operators.ConcatenateObject(Operators.ConcatenateObject(Operators.ConcatenateObject("update HT_CheckIn_H set Total_Price_vat=Total_Price_vat-", dataSet2.Tables[0].Rows[0]["Receipt_cin_vat_before"]), " where Cin_no='"), dataSet2.Tables[0].Rows[0]["Receipt_Ref"]), "'")));
			Module1.connect("update HT_Receipt_H set status_name='ยกเล\u0e34ก' where id=" + ListView1.SelectedItems[0].SubItems[0].Text);
	...
	private void ButtonItem1_Click(object sender, EventArgs e)
	{
		...
		{
			Print_Report.Print_SaleVat(Conversions.ToInteger(ListView1.SelectedItems[0].SubItems[0].Text), preview: false);
		}
	}
	...
	private void ButtonItem2_Click(object sender, EventArgs e)
	{
		...
		Cursor = Cursors.WaitCursor;
		MyProject.Forms.FrmAddSale.clear();
		MyProject.Forms.FrmAddSale.IEdit = ListView1.SelectedItems[0].SubItems[0].Text;
		MyProject.Forms.FrmAddSale.clear();
		MyProject.Forms.FrmAddSale.ShowDialog();
		Search();
		Cursor = Cursors.Default;
	...
	private void ListView1_SelectedIndexChanged(object sender, EventArgs e)
	{
		...
		ListView2.Items.Clear();
		DataSet dataSet = Module1.connect("select * from HT_Receipt_Ds where S_Sale_id=" + ListView1.SelectedItems[0].SubItems[0].Text + " order by id");
		checked
		{
			...
			while (true)
			{
				...
				if (num3 <= num4)
				{
					...
					listView.Items[count].SubItems.Add(Conversions.ToString(num2 + 1));
					...
					listView.Items[count].SubItems.Add(Strings.Format(RuntimeHelpers.GetObjectValue(dataSet.Tables[0].Rows[num2]["S_Unit"]), "#,##0"));
					...
					listView.Items[count].SubItems.Add(Strings.Format(RuntimeHelpers.GetObjectValue(dataSet.Tables[0].Rows[num2]["S_Price"]), "#,##0.00"));
					listView.Items[count].SubItems.Add(Strings.Format(RuntimeHelpers.GetObjectValue(dataSet.Tables[0].Rows[num2]["S_PriceDiscount"]), "#,##0.00"));
					listView.Items[count].SubItems.Add(Strings.Format(RuntimeHelpers.GetObjectValue(dataSet.Tables[0].Rows[num2]["S_Total"]), "#,##0.00"));
					listView = null;
					num2++;
					continue;
				}
