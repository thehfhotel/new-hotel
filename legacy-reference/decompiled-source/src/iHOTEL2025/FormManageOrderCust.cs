...
[DesignerGenerated]
public class FormManageOrderCust : Office2007Form
{
	...
	{
		System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(iHOTEL2025.FormManageOrderCust));
		...
		System.Drawing.Point location = new System.Drawing.Point(12, 146);
		...
		System.Drawing.Size size = new System.Drawing.Size(208, 268);
		listView3.Size = size;
		this.ListView1.TabIndex = 0;
		this.ListView1.UseCompatibleStateImageBehavior = false;
		this.ListView1.View = System.Windows.Forms.View.Details;
		this.ColumnHeader1.Text = "กล\u0e38\u0e48มราคา";
		...
		location = new System.Drawing.Point(285, 146);
		...
		size = new System.Drawing.Size(278, 249);
		listView6.Size = size;
		this.ListView2.TabIndex = 0;
		this.ListView2.UseCompatibleStateImageBehavior = false;
		this.ListView2.View = System.Windows.Forms.View.Details;
		this.ColumnHeader2.Text = "กล\u0e38\u0e48มราคา";
		this.ColumnHeader2.Width = 150;
		this.ColumnHeader3.Text = "มาพ\u0e31กภายใน (ว\u0e31น)";
		this.ColumnHeader3.TextAlign = System.Windows.Forms.HorizontalAlignment.Center;
		this.ColumnHeader3.Width = 120;
		System.Windows.Forms.Button button = this.Button5;
		location = new System.Drawing.Point(442, 397);
		...
		location = new System.Drawing.Point(541, 398);
		...
		location = new System.Drawing.Point(519, 398);
		...
		location = new System.Drawing.Point(226, 152);
		...
		location = new System.Drawing.Point(226, 263);
		...
		size = new System.Drawing.Size(575, 422);
		...
		margin = new System.Windows.Forms.Padding(3, 4, 3, 4);
		this.Margin = margin;
		this.Name = "FormManageOrderCust";
		this.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen;
		this.Text = "เปล\u0e35\u0e48ยนระด\u0e31บล\u0e39กค\u0e49าอ\u0e31ตโนม\u0e31ต\u0e34 (ปร\u0e31บราคาลง)";
	...
	{
		DataSet dataSet = Module1.connect("select * from HT_Order_Up where Cast_Type='" + ListViewMain.SelectedItems[0].SubItems[0].Text + "' order by id");
		checked
		{
			int num = dataSet.Tables[0].Rows.Count - 1;
			int num2 = 0;
	...
	private void Button5_Click(object sender, EventArgs e)
	{
		...
		Module1.connect("delete from HT_Order_Up where Cast_Type='" + ListViewMain.SelectedItems[0].SubItems[0].Text + "'");
		checked
		{
			int num = ListView2.Items.Count - 1;
			int num2 = 0;
			while (true)
			{
				...
				if (num3 <= num4)
				{
					object left = "INSERT INTO [HT_Order_Up]";
