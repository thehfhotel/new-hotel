...
[DesignerGenerated]
public class ReportContnueRoom : Office2007Form
{
	...
	private void Button1_Click(object sender, EventArgs e)
	{
		checked
		{
			if (DateTime.Compare(DateTimePicker1.Value.Date, DateTimePicker2.Value.Date) == 0)
			{
				...
				CrystalReportDaysContenue crystalReportDaysContenue = new CrystalReportDaysContenue();
			...
			MyProject.Forms.FrmPrint.Close();
			MyProject.Forms.FrmPrint.Show();
			CrystalReportDaysContenue crystalReportDaysContenue2 = new CrystalReportDaysContenue();
