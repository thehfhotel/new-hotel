...
[DesignerGenerated]
public class FrmBookMain : Office2007Form
{
	...
	private void InitializeComponent()
	{
		...
		System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(iHOTEL2025.FrmBookMain));
		...
		this.PanelEx1.Text = "รายการใบจองห\u0e49องพ\u0e31ก (แบบไม\u0e48ระบ\u0e38ห\u0e49อง)  |";
		...
		size = new System.Drawing.Size(92, 420);
		...
		size = new System.Drawing.Size(86, 383);
		...
		this.ItemContainer1.SubItems.AddRange(new DevComponents.DotNetBar.BaseItem[4] { this.ButtonCancel, this.ButtonItem2, this.ButtonItem1, this.ButtonItem3 });
		...
		location = new System.Drawing.Point(92, 24);
		...
		size = new System.Drawing.Size(872, 420);
		panelEx6.Size = size;
		...
		this.ListView2.Columns.AddRange(new System.Windows.Forms.ColumnHeader[7] { this.ColumnHeader5, this.ColumnHeader6, this.ColumnHeader7, this.ColumnHeader10, this.ColumnHeader11, this.ColumnHeader17, this.ColumnHeader18 });
		...
		size = new System.Drawing.Size(861, 160);
		listView3.Size = size;
		...
		this.ColumnHeader7.Text = "ประเภทห\u0e49องพ\u0e31ก";
		...
		size = new System.Drawing.Size(861, 85);
		groupBox4.Size = size;
		...
		this.ListView1.Columns.AddRange(new System.Windows.Forms.ColumnHeader[10] { this.ColumnHeader3, this.ColumnHeader4, this.ColumnHeader9, this.ColumnHeader14, this.ColumnHeader12, this.ColumnHeader13, this.ColumnHeader2, this.ColumnHeader15, this.ColumnHeader1, this.ColumnHeader8 });
		...
		size = new System.Drawing.Size(861, 131);
		listView6.Size = size;
		...
		this.Text = "รายการใบจองห\u0e49องพ\u0e31ก (แบบไม\u0e48ระบ\u0e38ห\u0e49อง)";
	...
	public void Search()
	{
		...
		object left = "select * from HT_Book_H where book_room_type=1";
		...
		checked
		{
			...
			while (true)
			{
				...
				ListView1.Items[count].SubItems.Add(Strings.Format(RuntimeHelpers.GetObjectValue(dataSet.Tables[0].Rows[num3]["Book_Date_in"]), "[dd-MM-yy HH:mm]") + " ถ\u0e36ง " + Strings.Format(RuntimeHelpers.GetObjectValue(dataSet.Tables[0].Rows[num3]["Book_Date_out"]), "[dd-MM-yy HH:mm]"));
	...
	private void ButtonItem3_Click(object sender, EventArgs e)
	{
		...
		{
			Print_Report.print_booking_type(ListView1.SelectedItems[0].SubItems[1].Text);
		}
	}
}
