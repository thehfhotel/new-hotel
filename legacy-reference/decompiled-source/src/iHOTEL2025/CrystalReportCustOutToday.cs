...
public class CrystalReportCustOutToday : ReportClass
{
	...
	public override string ResourceName
	{
		get
		{
			return "CrystalReportCustOutToday.rpt";
		}
		set
		{
		}
	...
	public override string FullResourceName
	{
		get
		{
			return "iHOTEL2025.CrystalReportCustOutToday.rpt";
		}
		set
		{
		}
	...
	[DebuggerNonUserCode]
	static CrystalReportCustOutToday()
	{
		Class2.LH6iGfYz9j3MJ();
		__ENCList = new List<WeakReference>();
	}

	public CrystalReportCustOutToday()
	{
		Class2.LH6iGfYz9j3MJ();
