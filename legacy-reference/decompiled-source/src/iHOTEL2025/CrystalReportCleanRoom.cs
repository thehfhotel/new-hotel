...
public class CrystalReportCleanRoom : ReportClass
{
	...
	public override string ResourceName
	{
		get
		{
			return "CrystalReportCleanRoom.rpt";
		}
		set
		{
		}
	...
	public override string FullResourceName
	{
		get
		{
			return "iHOTEL2025.CrystalReportCleanRoom.rpt";
		}
		set
		{
		}
	...
	[DebuggerNonUserCode]
	static CrystalReportCleanRoom()
	{
		Class2.LH6iGfYz9j3MJ();
		__ENCList = new List<WeakReference>();
	}

	public CrystalReportCleanRoom()
	{
		Class2.LH6iGfYz9j3MJ();
