...
[DesignerGenerated]
public class ReportCustOut : Office2007Form
{
	...
	private void InitializeComponent()
	{
		...
		this.Margin = margin;
		this.Name = "ReportCustOut";
		this.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen;
		this.Text = "รายงานแขกท\u0e35\u0e48ออกไปแล\u0e49ว";
	...
	private void Button1_Click(object sender, EventArgs e)
	{
		...
		checked
		{
			...
			while (true)
			{
				...
				{
					string_2 = Conversions.ToString(Operators.ConcatenateObject("ค\u0e49างจ\u0e48าย ", dataSet2.Tables[0].Rows[num6]["total_price_balance"]));
				}
				else if (Operators.ConditionalCompareObjectLess(dataSet2.Tables[0].Rows[num6]["total_price_balance"], 0, TextCompare: false))
				{
					...
					string_2 = Conversions.ToString(Operators.ConcatenateObject("จ\u0e48ายเก\u0e34น ", right4));
				}
