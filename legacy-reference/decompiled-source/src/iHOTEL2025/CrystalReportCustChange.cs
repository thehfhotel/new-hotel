...
public class CrystalReportCustChange : ReportClass
{
	...
	public override string ResourceName
	{
		get
		{
			return "CrystalReportCustChange.rpt";
		}
		set
		{
		}
	...
	public override string FullResourceName
	{
		get
		{
			return "iHOTEL2025.CrystalReportCustChange.rpt";
		}
		set
		{
		}
	...
	[DebuggerNonUserCode]
	static CrystalReportCustChange()
	{
		Class2.LH6iGfYz9j3MJ();
		__ENCList = new List<WeakReference>();
	}

	public CrystalReportCustChange()
	{
		Class2.LH6iGfYz9j3MJ();
