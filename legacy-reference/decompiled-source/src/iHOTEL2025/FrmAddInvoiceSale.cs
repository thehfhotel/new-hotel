...
[DesignerGenerated]
public class FrmAddInvoiceSale : Office2007Form
{
	...
	[DebuggerNonUserCode]
	static FrmAddInvoiceSale()
	{
		Class2.LH6iGfYz9j3MJ();
		__ENCList = new List<WeakReference>();
	}

	public FrmAddInvoiceSale()
	{
		Class2.LH6iGfYz9j3MJ();
	...
	private void InitializeComponent()
	{
		...
		System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(iHOTEL2025.FrmAddInvoiceSale));
		...
		location = new System.Drawing.Point(642, 47);
		...
		this.Tno1.BackColor = System.Drawing.Color.White;
		...
		location = new System.Drawing.Point(500, 306);
		...
		this.ButtonX3.Text = "บ\u0e31นท\u0e36ก /พ\u0e34มพ\u0e4cใบแจ\u0e49งหน\u0e35\u0e49";
		...
		System.Windows.Forms.Label label31 = this.Label19;
		location = new System.Drawing.Point(0, 155);
		label31.Location = location;
		this.Label19.Name = "Label19";
		System.Windows.Forms.Label label32 = this.Label19;
		...
		size = new System.Drawing.Size(151, 18);
		label48.Size = size;
		this.Label1.TabIndex = 21;
		this.Label1.Text = "เพ\u0e34\u0e48มรายการใบแจ\u0e49งหน\u0e35\u0e49";
		...
		margin = new System.Windows.Forms.Padding(3, 4, 3, 4);
		this.Margin = margin;
		this.Name = "FrmAddInvoiceSale";
		this.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen;
		this.Text = "เพ\u0e34\u0e48มรายการใบแจ\u0e49งหน\u0e35\u0e49";
	...
	public void Adlist(string sender)
	{
		...
		checked
		{
			if (Operators.CompareString(sender, "เพ\u0e34\u0e48ม", TextCompare: false) == 0)
			{
				...
				{
					MessageBox.Show("ได\u0e49พบรายการส\u0e34นค\u0e49า : " + Tno1.Text + " ในใบแจ\u0e49งหน\u0e35\u0e49แล\u0e49ว");
					ClearAdd();
					return;
				}
	...
	private void Button1_Click(object sender, EventArgs e)
	{
		...
		if (Operators.ConditionalCompareObjectNotEqual(MyProject.Forms.FormSearchCust.SelectNO, "", TextCompare: false))
		{
			...
			AName.Text = Conversions.ToString(dataSet.Tables[0].Rows[0]["Cust_Work_Name"]);
			Atel.Text = Conversions.ToString(dataSet.Tables[0].Rows[0]["Cust_Work_tel"]);
			AFax.Text = Conversions.ToString(dataSet.Tables[0].Rows[0]["Cust_Work_fax"]);
			Atax.Text = dataSet.Tables[0].Rows[0]["Cust_Work_tax"].ToString();
			Aaddress.Text = Conversions.ToString(NewLateBinding.LateGet(NewLateBinding.LateGet(NewLateBinding.LateGet(NewLateBinding.LateGet(NewLateBinding.LateGet(NewLateBinding.LateGet(dataSet.Tables[0].Rows[0]["W_Address"], null, "Replace", new object[2] { "หม\u0e39\u0e48  ", "" }, null, null, null), null, "Replace", new object[2] { "ซอย ", "" }, null, null, null), null, "Replace", new object[2] { "ถนน ", "" }, null, null, null), null, "Replace", new object[2] { "เขต/อำเภอ ", "" }, null, null, null), null, "Replace", new object[2] { "แขวง/ตำบล ", "" }, null, null, null), null, "Replace", new object[2] { "จ\u0e31งหว\u0e31ด ", "" }, null, null, null));
			Tno.Focus();
		}
	}
	...
	public void CheckEdit()
	{
		...
		Text = "แก\u0e49ไขใบแจ\u0e49งหน\u0e35\u0e49";
		Label1.Text = "แก\u0e49ไขใบแจ\u0e49งหน\u0e35\u0e49";
		DataSet dataSet = Module1.connect(Conversions.ToString(Operators.ConcatenateObject("select * from HT_Invoice_H where id=", IEdit)));
		DataSet dataSet2 = Module1.connect(Conversions.ToString(Operators.ConcatenateObject(Operators.ConcatenateObject("select * from HT_Invoice_Ds where S_sale_id=", IEdit), " order by id")));
	...
	{
		C_ID = "";
		Text = "เพ\u0e34\u0e48มรายการใบแจ\u0e49งหน\u0e35\u0e49";
		Label1.Text = "เพ\u0e34\u0e48มรายการใบแจ\u0e49งหน\u0e35\u0e49";
	...
	{
		int num = 1;
		DataSet dataSet = Module1.connect("select top 1 Receipt_no from HT_Invoice_H where Receipt_Date between '" + Conversions.ToString(Adate.Value.Month) + "/01/" + Conversions.ToString(Adate.Value.Year) + " 00:00:00' and '" + Conversions.ToString(Adate.Value.Month) + "/" + Conversions.ToString(DateTime.DaysInMonth(Adate.Value.Year, Adate.Value.Month)) + "/" + Conversions.ToString(Adate.Value.Year) + " 23:59:59' order by Receipt_no Desc");
		checked
		{
			if (dataSet.Tables[0].Rows.Count == 0)
			{
			...
			return Strings.Format(DateTime.Now, "INVyyMM") + "-" + Strings.Format(num, "0000");
		}
	}
	...
	public void Save(bool pp)
	{
		...
		{
			MessageBox.Show("กร\u0e38ณาเพ\u0e34\u0e48มใบแจ\u0e49งหน\u0e35\u0e49");
			return;
		}
	...
	{
		if (MessageBox.Show("ค\u0e38ณต\u0e49องการบ\u0e31นท\u0e36กใบแจ\u0e49งหน\u0e35\u0e49หร\u0e37อไม\u0e48", "บ\u0e31นท\u0e36กใบแจ\u0e49งหน\u0e35\u0e49", MessageBoxButtons.YesNo, MessageBoxIcon.Asterisk) == DialogResult.No)
		{
			return;
		}
		object obj = Module1.get_id("HT_Invoice_H", "id");
		string sIR = GetSIR();
		idsave = Conversions.ToInteger(obj);
		object left = "";
		left = Operators.ConcatenateObject(left, "INSERT INTO [HT_Invoice_H]");
		...
		checked
		{
			...
			while (true)
			{
				...
				left = "";
				left = Operators.ConcatenateObject(left, "INSERT INTO [HT_Invoice_Ds]");
			...
			if (pp)
			{
				Print_Report.Print_INVVat(Conversions.ToInteger(obj), preview: false);
			}
			clear();
			BsaveEdit.Text = "เพ\u0e34\u0e48ม";
			Close();
	...
	{
		if (MessageBox.Show("ค\u0e38ณต\u0e49องการแก\u0e49ไขใบแจ\u0e49งหน\u0e35\u0e49หร\u0e37อไม\u0e48", "แก\u0e49ไขใบแจ\u0e49งหน\u0e35\u0e49", MessageBoxButtons.YesNo, MessageBoxIcon.Asterisk) != DialogResult.Yes)
		{
			return;
		}
		object left = "";
		left = Operators.ConcatenateObject(left, "UPDATE [HT_Invoice_H] SET ");
		...
		left = Operators.ConcatenateObject(left, ",[Receipt_cin_vat_before]=" + Conversions.ToString(0));
		...
		Module1.connect(Conversions.ToString(left));
		Module1.connect(Conversions.ToString(Operators.ConcatenateObject("delete from HT_Invoice_Ds where S_Sale_id=", IEdit)));
		checked
		{
			int num = ListView1.Items.Count - 1;
			int num2 = 0;
			...
			MessageBox.Show("แก\u0e49ไขใบแจ\u0e49งหน\u0e35\u0e49เสร\u0e47จเร\u0e35ยบร\u0e49อย");
			if (pp)
			{
				Print_Report.Print_INVVat(Conversions.ToInteger((object)IEdit), preview: false);
			}
			BsaveEdit.Text = "เพ\u0e34\u0e48ม";
			Close();
		}
	...
	public void B2_Click(string c_no, bool bool_0 = false)
	{
		...
		AName.Text = Conversions.ToString(dataSet2.Tables[0].Rows[0]["Cust_Work_Name"]);
		Atel.Text = Conversions.ToString(dataSet2.Tables[0].Rows[0]["Cust_Work_tel"]);
		AFax.Text = Conversions.ToString(dataSet2.Tables[0].Rows[0]["Cust_Work_fax"]);
		...
		DataSet dataSet4 = Module1.connect("select * from HT_Products where Pro_no='P-001' or pro_name='ค\u0e48าห\u0e49อง'");
		checked
		{
	...
	{
		if (e.KeyData == Keys.Return && Operators.CompareString(Tno.Text, "*", TextCompare: false) == 0)
		{
			BsaveEdit.Text = "เพ\u0e34\u0e48ม";
			BsaveEdit.Enabled = true;
			Tno1.Text = "*";
			...
			Tnum.Text = Conversions.ToString(1);
			Tprice.Text = Conversions.ToString(0);
			Ttotal.Text = Conversions.ToString(0);
			Tno.Text = "";
			Tname.Focus();
		}
	}
