...
[DesignerGenerated]
public class ReportCustOutToday : Office2007Form
{
	...
	private void Button1_Click(object sender, EventArgs e)
	{
		...
		checked
		{
			...
			CrystalReportCustOutToday crystalReportCustOutToday = new CrystalReportCustOutToday();
			crystalReportCustOutToday.SetDataSource(Module1.localdata);
			MyProject.Forms.FrmPrint.CrystalReportViewer1.ReportSource = crystalReportCustOutToday;
