...
- **CI/CD pipeline credential cleanup (Batch A of post-Phase-5.5 audit).**
  ...
  - **Removed `sshpass -p banana`** from the `deploy-hfville` job
  ...
  - **Replaced `NewHotel@2026!` literal** in the `test-backend` job
  ...
  - **Replaced `HfVille@2026!`, `12345678`, and `NewHotel@2026!`
