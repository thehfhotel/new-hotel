...
## [2.77.0](https://github.com/thehfhotel/new-hotel/compare/v2.76.0...v2.77.0) (2026-09-16)
...
* **housekeeping:** record suppressed audit insert attempts ([#333](https://github.com/thehfhotel/new-hotel/issues/333)) ([c346fe1](https://github.com/thehfhotel/new-hotel/commit/c346fe1ab18571b29ed006ab9255ae6defad12e8))
...
* **alerts:** detect a stalled loyalty-channel writeback inside the hold's 2h TTL ([#303](https://github.com/thehfhotel/new-hotel/issues/303)) ([de80de4](https://github.com/thehfhotel/new-hotel/commit/de80de49bbb47ce706083b46a273d5f3cfae6b91))
* **alerts:** pager-tier Slack sends lead with a channel mention ([67f4be7](https://github.com/thehfhotel/new-hotel/commit/67f4be7ad5a7f624898af06eb6330c5f7f20784b))
* **backfill:** add backfill_guest_registry_companions for the TM.30 companion gap ([1dd38ea](https://github.com/thehfhotel/new-hotel/commit/1dd38ea7ca6895f4a3e73acd28568bb7f34edc8f))
* **backfill:** add backfill_receipt_payments to close the ht_payments mirror gap ([a81a5b5](https://github.com/thehfhotel/new-hotel/commit/a81a5b5ec9f7eaaf1d5ae417af2218dfd1b0170f))
* **backfill:** add backfill_room_calendar for the pre-coverage night deficit ([e8fbafb](https://github.com/thehfhotel/new-hotel/commit/e8fbafb99ffb2dcb280e9a24eda009b6bfc923e9))
* **channel:** count parked bookings against loyalty-channel inventory ([#304](https://github.com/thehfhotel/new-hotel/issues/304)) ([0011b43](https://github.com/thehfhotel/new-hotel/commit/0011b43581de8b0c42842752669d019256776147))
* **channel:** idempotency keys on the loyalty hold create, and accept both checked-in spellings ([#305](https://github.com/thehfhotel/new-hotel/issues/305)) ([1243d89](https://github.com/thehfhotel/new-hotel/commit/1243d8997a45b7844c3f4771877ae3df4fb930e1))
* **channel:** loyalty-app booking channel + membership link (rebased, migration 086) ([#290](https://github.com/thehfhotel/new-hotel/issues/290)) ([6a257eb](https://github.com/thehfhotel/new-hotel/commit/6a257eb1c87306560fcf0087f87bd640695defd1))
* **channel:** serialize the last room and hold a floor for the desk (B8e) ([#311](https://github.com/thehfhotel/new-hotel/issues/311)) ([a4bb678](https://github.com/thehfhotel/new-hotel/commit/a4bb67811c98c53871b46eef893efdae77b06268))
* **checkin:** check a reservation in from our own app, with the booking link ([#306](https://github.com/thehfhotel/new-hotel/issues/306)) ([5d64546](https://github.com/thehfhotel/new-hotel/commit/5d64546b8c87b6ed6b9a55703b159820b874efca))
* **deploy:** add force_deploy workflow input; enable missing_pg re-ingest on HF Hotel ([42258ce](https://github.com/thehfhotel/new-hotel/commit/42258ce84eb4217c2958397358ddc60e9a5b1b52))
* **folio:** tell the desk an app deposit is already paid before iHOTEL says 0 ([#302](https://github.com/thehfhotel/new-hotel/issues/302)) ([71721f0](https://github.com/thehfhotel/new-hotel/commit/71721f0ead173066ba022611c1ab2d21436dcfda))
* **health:** surface the built commit as `revision` on /health ([#299](https://github.com/thehfhotel/new-hotel/issues/299)) ([545c855](https://github.com/thehfhotel/new-hotel/commit/545c855b75f0d39ebb16d923890136637b5def87))
* **hk:** answered room-checks survive a desk reload; de-race the DB test fixtures ([4018583](https://github.com/thehfhotel/new-hotel/commit/401858329966444209945a412d74b4464b7933a1))
* **hk:** declare the hfid_resolve_secret compose secret ([b6b902a](https://github.com/thehfhotel/new-hotel/commit/b6b902a0d7e7cdc53582a57ec0b6b8c0c37256cc))
* **hk:** deep-link แจ้งซ่อม / เบิกของ to the Housekeeping ops app ([8c09ba7](https://github.com/thehfhotel/new-hotel/commit/8c09ba70d59309897951e231490cade2c43de1f0))
* **hk:** enqueue MarkRoomClean on maid "done", retire broken-item intake ([b97ff4d](https://github.com/thehfhotel/new-hotel/commit/b97ff4d6db603e90dc7bb540b8a60b8ba6a972dd))
* **hk:** frontend half — branch picker, mark-dirty button, reception live board ([f9dc59d](https://github.com/thehfhotel/new-hotel/commit/f9dc59df48edba90e9124275aa1020bc0fc4267d))
* **hk:** give reception the maid's merged truth, and retire the duplicate แจ้งซ่อม ([1ac4c04](https://github.com/thehfhotel/new-hotel/commit/1ac4c04f880e7c5cbf2ea8ad17e975003869f02f))
* **hk:** let the few who work both hotels pick either, by grant ([aa98ac8](https://github.com/thehfhotel/new-hotel/commit/aa98ac8541ddfcd056d2a7dbce453d31d65690a7))
* **hk:** per-employee location enforcement from HF ID (DARK; payload key only) ([cd54bd0](https://github.com/thehfhotel/new-hotel/commit/cd54bd0fdbe73f8559405ec5a6333c9a3de219fd))
* **hk:** read-only reception viewer role on the maid surface ([35f6adf](https://github.com/thehfhotel/new-hotel/commit/35f6adf4a9ae925fb668102ee3370f44f288d83e))
* **hk:** Report HK — per-room daily report filled by the maid, verified by reception, photo evidence both sides ([655060c](https://github.com/thehfhotel/new-hotel/commit/655060cd8aa4ea63b562f643f2f5b547588215cf))
* **hk:** Report HK v2 — photo-backed ticks captured zone by zone, full photo management ([345bf7d](https://github.com/thehfhotel/new-hotel/commit/345bf7dcea8c9c5bc730683af82bb3c0c33d96a1))
* **hk:** required branch, maid mark-dirty (dark), reception cleaning feed + Ville legacy-key repair bin ([c0c83c1](https://github.com/thehfhotel/new-hotel/commit/c0c83c1ff5a9d880590d8134e753930658e6f2b7))
* **hk:** room signals — canned reception↔maid coordination with ขอเช็คห้อง (ADR 0008) ([0938e95](https://github.com/thehfhotel/new-hotel/commit/0938e95a11569e14b323b14d076de9e4ecfc500b))
* **hk:** serve iHOTEL's room-clean status, and confirm before mark-dirty ([eec8a25](https://github.com/thehfhotel/new-hotel/commit/eec8a256bfa9102f5f7cb2da7d060f30e37bb313))
* **hk:** show explicit clean/dirty chips on every room, not just a dot ([6713a25](https://github.com/thehfhotel/new-hotel/commit/6713a25466bdb2d2570cf2bd88f9026151bfe1eb))
* **hk:** show occupancy and today's movements on the maid's room list ([73c568e](https://github.com/thehfhotel/new-hotel/commit/73c568e8f397c512f0c050a03935c1c6460075cc))
* **hk:** ขาดผ้า is completable — เติมผ้าแล้ว by the maid, open-shortage work queue on /hk ([b0c0f66](https://github.com/thehfhotel/new-hotel/commit/b0c0f66385ea8852060100fbc4b0cd8616c55c20))
* **hk:** แจ้งขาดผ้า — per-room linen-shortage report on the maid /hk surface ([5362837](https://github.com/thehfhotel/new-hotel/commit/5362837272c50dac1d7839c4b2c1bd5de26d57ea))
* **hk:** ผ้าปูที่นอน linen kind + a same-day ขาดผ้า tag on the room chips ([7ad3513](https://github.com/thehfhotel/new-hotel/commit/7ad3513153ea0fc76c47284df3470f0737472290))
* **middleware:** Stage 3 — notify endpoint, stale latch, toast, tray, autostart ([cbffc97](https://github.com/thehfhotel/new-hotel/commit/cbffc97179627a189c5236cf3c6f671846f8f60a))
* **middleware:** Stage 4 — iHOTEL refresh action (UIA locate, PostMessage act) ([134d70f](https://github.com/thehfhotel/new-hotel/commit/134d70fdb69c368f6fae6f2d7946d93af869f03c))
* **notify:** enable legacy-stale emission at HF Ville — pilot live ([c863817](https://github.com/thehfhotel/new-hotel/commit/c863817dc04b0cad64df722af8944460f8187196))
* **notify:** LegacyStaleBridge relays legacy_stale SSE to the tray middleware ([6bf709a](https://github.com/thehfhotel/new-hotel/commit/6bf709a325bb920cfd92336d32ebe911b743562a))
* **ota-bridge:** declare the ota_bridge_token compose secrets ([2acc996](https://github.com/thehfhotel/new-hotel/commit/2acc996c889621eaf475983fe7a3c8750aeddcd7))
* **ota-bridge:** machine surface /api/ota/* + reconcile read (DARK; payload key only) ([a1527b2](https://github.com/thehfhotel/new-hotel/commit/a1527b27b144995244b33ce5c8c2bb26f911c4b7))
* **ota-bridge:** N3 — enable the /api/ota surface (permissive) ([4c53f26](https://github.com/thehfhotel/new-hotel/commit/4c53f267fd46617b207f24838d6180f1041a268d))
* **reconcile:** enable calendar class-B re-stamp at HF Hotel — first live test ([524d81e](https://github.com/thehfhotel/new-hotel/commit/524d81e70287469480621665efca613ca3b3e75d))
* **reconcile:** enable calendar re-stamp at Ville — HF Hotel live test verified ([6d279d2](https://github.com/thehfhotel/new-hotel/commit/6d279d2802e003d5abe89713188e7e0aa60b3965))
* **reconcile:** enable mirror probe at HF Hotel — T2 arm 8 of 8 ([6add0e9](https://github.com/thehfhotel/new-hotel/commit/6add0e9a5f78967400612a92e6bb9ddec0c95317))
* **reconcile:** enable mirror probe at HF Hotel — T2 arm 8 of 8, take 3 ([dcb3863](https://github.com/thehfhotel/new-hotel/commit/dcb3863589e66a1a646abcf8ca9121341d1605da))
* **reports:** answer "what is our direct share?" with a channel rollup ([#301](https://github.com/thehfhotel/new-hotel/issues/301)) ([3a601a3](https://github.com/thehfhotel/new-hotel/commit/3a601a3b9b168ce5d3fea90696ce2434abf297eb))
* **reports:** morning loyalty reconciliation for reception (B8f / L6) ([#310](https://github.com/thehfhotel/new-hotel/issues/310)) ([74bdb20](https://github.com/thehfhotel/new-hotel/commit/74bdb2017855da64f0faa2be3e6411b5ecf659c6))
* **reservations:** show where a booking came from at the desk ([#300](https://github.com/thehfhotel/new-hotel/issues/300)) ([6e1dfd3](https://github.com/thehfhotel/new-hotel/commit/6e1dfd3a923a3b4b7225c4383a777127c1378f51))
* **rooms:** จัดผัง layout saves fan out to other terminals via SSE ([741fbdd](https://github.com/thehfhotel/new-hotel/commit/741fbdd18ad82462a1b5286ad317ab5bb44e1708))
* **shell:** scope the HF One band to the desk the viewer is standing at ([9714e79](https://github.com/thehfhotel/new-hotel/commit/9714e79f508d381c660d798f540e075e8fdf85a9))
* **sync:** eager product mirror ARMED on the CT path; durable watchdog episodes ([6e4a3df](https://github.com/thehfhotel/new-hotel/commit/6e4a3df705975195dc787dc300163fcd9898de38))
* **sync:** emit a legacy_stale signal when a writeback lands (ships dark) ([ad2f423](https://github.com/thehfhotel/new-hotel/commit/ad2f423517b0e2d22c31c677810a0ad7300f6ed1))
* **sync:** enable guest-registry reconcile arm on HF Hotel (T2 step 4/8) ([142942d](https://github.com/thehfhotel/new-hotel/commit/142942d88f321a0231564e5b80977a947ea5dfb9))
* **sync:** enable guest-registry reconcile arm on HF Ville (T2 step 3/8) ([68a30cc](https://github.com/thehfhotel/new-hotel/commit/68a30ccb04df7deb38bb5cbade2ee5910a780b61))
* **sync:** enable payment-ledger probe on HF Hotel (T2 step 6/8) ([ac8ccb5](https://github.com/thehfhotel/new-hotel/commit/ac8ccb55ddf1bf9e931f5dfb295149925bcb0ff6))
* **sync:** enable payment-ledger probe on HF Ville (T2 step 5/8) ([7aa6eb7](https://github.com/thehfhotel/new-hotel/commit/7aa6eb710a5a3d3cb8ac2fe585df99cc2f0a0a5e))
* **sync:** enable payments reconcile arm on HF Hotel (T2 step 2/8) ([c4817d7](https://github.com/thehfhotel/new-hotel/commit/c4817d7740cd20c68668fa144fe8e742a45542f0))
* **sync:** enable payments reconcile arm on HF Ville (T2 canary, 48h soak) ([5936d99](https://github.com/thehfhotel/new-hotel/commit/5936d990051234a13edf89aefa3a06dd4d88fba7))
* **sync:** enable the NULL-sentinel tripwire and Ville mirror probe ([125c506](https://github.com/thehfhotel/new-hotel/commit/125c50604c1fe1912c1fefa9b94bc30d5109c7bd))
* **sync:** guest-registry folio reconcile arm, dark behind RECONCILE_GUEST_REGISTRY_ARM_ENABLED ([6fddd6b](https://github.com/thehfhotel/new-hotel/commit/6fddd6b1fc2e23b4b3164a11368bc969beebdd4a))
* **sync:** mirror-table probe, dark behind RECONCILE_MIRROR_PROBE_ENABLED ([1259ca4](https://github.com/thehfhotel/new-hotel/commit/1259ca407fd2424258fc8dde99062750492fd660))
* **sync:** payment-ledger per-folio SUM probe, dark behind RECONCILE_PAYMENT_LEDGER_PROBE_ENABLED ([7a928fd](https://github.com/thehfhotel/new-hotel/commit/7a928fd2582f885614bb5c8ba6efb54d4c573548))
* **sync:** payments reconcile arm, dark behind RECONCILE_PAYMENTS_ARM_ENABLED ([3c45ba6](https://github.com/thehfhotel/new-hotel/commit/3c45ba686dc3b033613cb5235e2622de1b4d50f9))
* **sync:** ratcheting era floor for the payment-ledger probe (migration 084) ([18f90f1](https://github.com/thehfhotel/new-hotel/commit/18f90f1e446bf9d380e0afe2eb3bab65f40867a8))
* **sync:** re-enable the Ville mirror probe with the comparison fixed (T2 step 7a) ([402887e](https://github.com/thehfhotel/new-hotel/commit/402887e99fdd4e1f90205c1723851aef9432ff38))
* **sync:** record room-calendar divergence on the business key (refs [#273](https://github.com/thehfhotel/new-hotel/issues/273)) ([60deef0](https://github.com/thehfhotel/new-hotel/commit/60deef0db0d84b681e28f14b3a3c26f9ec806a1c))
* **sync:** scheduler event-name registry; calendar probe rows can now close ([12c9f27](https://github.com/thehfhotel/new-hotel/commit/12c9f27b93a60cbd6f7b5d6cd42354fdf224bce9))
* **sync:** tripwire for the NULL-clear gap accepted in ADR 0005 ([ed338f6](https://github.com/thehfhotel/new-hotel/commit/ed338f6bb17258fb04ef21f36883d92d8997386c))
* **web:** ship a favicon.ico so the implicit browser request stops 404ing ([3f4aad3](https://github.com/thehfhotel/new-hotel/commit/3f4aad37f8fc993db95ec61aa9c3078daaa6b5e6))
* **writeback:** CreateCashEntry intent + cash_legacy_id back-population ([be6bbb4](https://github.com/thehfhotel/new-hotel/commit/be6bbb45473c44f3f1dd4a0d76f46799bda6f125))
* **writeback:** per-intent HF Ville allowlist (HFVILLE_WRITEBACK_INTENTS) ([1448c59](https://github.com/thehfhotel/new-hotel/commit/1448c59d73402475b0b47a088ed6adc65774f02c))


### Fixed

* **alerts:** calibrate the alert surface — escalation, mute detectors, boot bursts, fail-closed defaults ([1b06849](https://github.com/thehfhotel/new-hotel/commit/1b0684996f05bdfed8aad42da6d33ef41cdc4d2e))
* **alerts:** finish the reword, cool the retention-overflow storm, log dropped pages ([fcf0fa8](https://github.com/thehfhotel/new-hotel/commit/fcf0fa8bc278f2df30a32ece15104f69d4769e7b))
* **api:** stop SSE clients exhausting the PG pool — shared LISTEN fan-out ([517b907](https://github.com/thehfhotel/new-hotel/commit/517b90713e4a903970290a8c3090872dd9f4b801))
* **compose:** disable inherited healthcheck on the four backfill one-shots ([d0f6fec](https://github.com/thehfhotel/new-hotel/commit/d0f6fecb53d5d4d7da8deea4d383a1661736f140))
* **db:** bound and poison-guard the tiberius Query API shape ([45d9cfe](https://github.com/thehfhotel/new-hotel/commit/45d9cfefa71b3d5c14616447591e71383f49611d))
* **db:** discard MSSQL connections poisoned by per-op timeouts ([7607793](https://github.com/thehfhotel/new-hotel/commit/760779312729f6f27c31960fb178a065b0f24b47))
* **db:** evict dead legacy-MSSQL connections on validation timeout (bb8 re-queue) ([#293](https://github.com/thehfhotel/new-hotel/issues/293)) ([0961478](https://github.com/thehfhotel/new-hotel/commit/0961478ec8ef22b1580dbaf9d6edb60d7c35e903))
* **deploy:** plumb HFVILLE_WRITEBACK_INTENTS, inert by default ([3207c40](https://github.com/thehfhotel/new-hotel/commit/3207c404f5b0f51b88b9e84995c28c60679507b0))
* **deps:** patch 4 high + 5 medium Next.js CVEs, plus postcss/sharp/js-yaml/brace-expansion ([f0a5fc1](https://github.com/thehfhotel/new-hotel/commit/f0a5fc1ebe4e1b2a117dabf37593b22f98feafba))
* **doc-anchors:** bare section anchors require a whole-token heading match ([#294](https://github.com/thehfhotel/new-hotel/issues/294)) ([5b7ea97](https://github.com/thehfhotel/new-hotel/commit/5b7ea973f463f0fc48906258da44fc2c9d2798fd))
* **hk:** admit hfville maid cleaning past the Ville write gate ([5bbc533](https://github.com/thehfhotel/new-hotel/commit/5bbc533f5f54b9efbf3acd99cba069641305f254))
* **hk:** exempt the /hk maid surface from the cookie-session AuthGuard ([cbf759a](https://github.com/thehfhotel/new-hotel/commit/cbf759a70f219aa8b53260c316732b77952c605c))
* **hk:** gate repair_room_legacy_keys on its targets + re-ask on a stale branch ([e7cd000](https://github.com/thehfhotel/new-hotel/commit/e7cd00047cbaf5d7b058b0f6ceee9fd37a01be04))
* **hk:** judge the maid's tap by the truth her screen showed her ([e603aa7](https://github.com/thehfhotel/new-hotel/commit/e603aa79c7b24f8cb5d30a5602cba85f0601f9e9))
* **hk:** refetch the maid's rooms, so iHOTEL's status actually reaches her ([0a30079](https://github.com/thehfhotel/new-hotel/commit/0a3007934e432999c3a0a5a4119012b9bccef9a0))
* **hk:** report photos attach on old Android WebViews; gallery pick with multi-select ([348ba8e](https://github.com/thehfhotel/new-hotel/commit/348ba8ebb68596eeaa37a108b4c577d79bc6dcb6))
* **hk:** stop the dead PMS session probe on the maid surface ([6151c73](https://github.com/thehfhotel/new-hotel/commit/6151c73b8bf1655b5b15af8203ba6d1e267c2184))
* **middleware:** version field in the health-serialization test constructor ([00e26f9](https://github.com/thehfhotel/new-hotel/commit/00e26f909fd8e3706e10befa09de6efb20f88760))
* **reconcile:** calendar arm is a (room, night) set-diff, not a count ([c9eea7b](https://github.com/thehfhotel/new-hotel/commit/c9eea7beee0aba00387b17ae7cc7fe0a4ed9e59b))
* **rooms:** filter room status on derived state, not the stale column ([cffc0cd](https://github.com/thehfhotel/new-hotel/commit/cffc0cd5464bf12822569358d7d63977b3b7b767))
* **scheduler:** route legacy MSSQL reads through the timeout+poison wrapper ([050cace](https://github.com/thehfhotel/new-hotel/commit/050cacebe073fdab499480033a89bc4e75cf2599))
* **sync:** align the rooms detection hash with the room_clean inversion ([20edf18](https://github.com/thehfhotel/new-hotel/commit/20edf18a46a9a453c64db7469c3fa6423debe23d))
* **sync:** calendar mirror probe compares mirrored rows only (refs [#273](https://github.com/thehfhotel/new-hotel/issues/273), [#281](https://github.com/thehfhotel/new-hotel/issues/281)) ([445c347](https://github.com/thehfhotel/new-hotel/commit/445c34735795935cc5801d39998a78d04cb2f9ac))
* **sync:** close four silent-loss gaps in the CT idempotency gates ([5e1d014](https://github.com/thehfhotel/new-hotel/commit/5e1d0148ceb6beab11ae9aacb4aadda372e7e597))
* **sync:** close three gate/echo blind spots — multi-room reorder, rooms NULL-clear, companion surname ([e7e288b](https://github.com/thehfhotel/new-hotel/commit/e7e288b1d43c3ca4a38439ac0ff8f45de60d872c))
* **sync:** CT ceiling settle gate — stop advancing past in-flight commits ([0bc7e25](https://github.com/thehfhotel/new-hotel/commit/0bc7e254933a1fad879da8ae27326693fe0569df))
* **sync:** make per-table CT watermark safe to enable; drop the refuse-to-start guard ([29d6652](https://github.com/thehfhotel/new-hotel/commit/29d66528992d709038687b557a852ab7c697a62a))
* **sync:** propagate a cleared legacy booking note instead of dropping it ([4bbaf4c](https://github.com/thehfhotel/new-hotel/commit/4bbaf4ce1fef125bf736a52e41b368c968c8c226))
* **sync:** prune legacy-deleted rate tiers (scoped, graced, refuse-to-wipe) ([a252174](https://github.com/thehfhotel/new-hotel/commit/a252174831353b3399ae5c80170a04d8c9f1b21a))
* **sync:** refuse to start on unsafe per-table watermark; stop calling dropped changes "sync lag" ([14919ab](https://github.com/thehfhotel/new-hotel/commit/14919ab206ffeb3a2603ffefc1021a9cd5dd0c1c))
* **sync:** stop legacy re-import degrading app-authored cash entries ([4f6ea5c](https://github.com/thehfhotel/new-hotel/commit/4f6ea5cc633ee7fc5c1da86c9f39784703138f55))
* **sync:** stop the checkout double-count, wire inbound product sync, adopt echoed rows ([7b57edc](https://github.com/thehfhotel/new-hotel/commit/7b57edcc9d18953b9af50dca0a01966d5db1a511))
* **sync:** stop the global CT watermark clobbering unread tables mid-tick ([42dc2c0](https://github.com/thehfhotel/new-hotel/commit/42dc2c08f2389e256fa248ced073fccfde0ca4cb))
* **writeback:** mark_dirty must write Room_Clean='yes', not delegate to mark_clean ([5ce6be1](https://github.com/thehfhotel/new-hotel/commit/5ce6be1519990d6d5465d2a9b6cddf27010b1d4e))
* **writeback:** mark-dirty writes Room_Clean='yes' instead of inverting it ([6848a22](https://github.com/thehfhotel/new-hotel/commit/6848a226e006272167887bbb3c8a6e6e8777e808))
* **writeback:** name Cin_Work_number for what it is — iHOTEL's folio lock ([#291](https://github.com/thehfhotel/new-hotel/issues/291)) ([f581c79](https://github.com/thehfhotel/new-hotel/commit/f581c795ea6bf0096532eb1dab24daeea939a05b))
* **writeback:** revive the exhausted-job all-clear and collapse the exhausted alert storm ([6c80689](https://github.com/thehfhotel/new-hotel/commit/6c806897d5da7498924bab45a38088c6a543f174))
* **writeback:** stop minting an HT_Housewife row when flagging a room dirty ([ccf88c3](https://github.com/thehfhotel/new-hotel/commit/ccf88c35c477191e5a9fa728543f6b2ae61bcb0d))
* **writeback:** validate the Ville allowlist at boot; surface parked jobs ([fe42d5d](https://github.com/thehfhotel/new-hotel/commit/fe42d5d0784ce1ee52cd60b4683bfe15e402ef78))


### Changed

* **sse:** collapse the 12-name resync burst to a single event ([af8f14e](https://github.com/thehfhotel/new-hotel/commit/af8f14eae7a37ef3d0432a78d11a6cbacd0cf80d))
...
* **deploy:** deliver READER_RESOLVE_SECRET + CF_ACCESS_HK_AUD through the deploy payload ([#233](https://github.com/thehfhotel/new-hotel/issues/233)) ([3d60249](https://github.com/thehfhotel/new-hotel/commit/3d602496bb37c01b9a7d0c05dd4c4d77343a797b))
