...
mod tests {
    ...
    fn make_row_full(cust_no: &str, name: &str) -> HashMapRow {
        HashMapRow::new(TABLE)
            ...
            .with("Cust_IDcard", MockValue::Str("1234567890123".into()))
            .with(
                "Cust_Type_Main",
            ...
            .with("Cust_Add_tel", MockValue::Str("0812345678".into()))
    }
    ...
    fn project_extracts_all_columns_from_full_row() {
        ...
        assert_eq!(p.cust_idcard.as_deref(), Some("1234567890123"));
        ...
        assert_eq!(p.cust_phone.as_deref(), Some("0812345678"));
    }
