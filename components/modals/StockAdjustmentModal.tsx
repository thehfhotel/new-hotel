    ...
    >
      ...
      >
        ...
        <div className="flex items-center justify-between p-4 border-b">
          <div>
            <h2 className="text-xl font-bold text-gray-800">ปรับสต็อก</h2>
            ...
            {selectedItem && (
              <div className="mt-2 p-3 bg-blue-50 border border-blue-200 rounded-lg">
                <div className="flex items-center justify-between">
                  <div>
                    <div className="font-medium text-blue-800">{selectedItem.itemName}</div>
                    <div className="text-sm text-blue-600">{selectedItem.itemCode}</div>
                  </div>
                  <div className="text-right">
                    <div className="text-sm text-gray-600">คงเหลือปัจจุบัน</div>
          ...
          <div>
            ...
            {selectedItem && quantity && (
              <div className="mt-2 flex items-center gap-2 text-sm">
                <span className="text-gray-600">สต็อกใหม่:</span>
