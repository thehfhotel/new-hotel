    ...
    >
      ...
      >
        ...
        <div className="flex items-center justify-between p-4 border-b border-zinc-800">
          <div>
            <h2 className="text-xl font-bold text-zinc-100">เช็คอินด่วน</h2>
        ...
        <form onSubmit={handleSubmit} className="p-4 space-y-4">
          ...
          <div className="relative">
            ...
            {selectedCustomer && (
              <div className="mt-2 p-2 bg-red-500/10 border border-zinc-700 rounded-lg text-sm text-red-400">
