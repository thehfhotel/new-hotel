...
const COMMANDS: Command[] = [
  ...
  { id: 'housekeeping', label: 'งานแม่บ้าน', hint: 'ไปที่', icon: Sparkles, href: '/housekeeping', keywords: 'housekeeping clean แม่บ้าน' },
  { id: 'maintenance', label: 'แจ้งซ่อม', hint: 'ไปที่', icon: Wrench, href: '/maintenance', keywords: 'maintenance repair ซ่อม' },
