              ...
              <div>
                ...
                <div className="flex gap-4">
                  <label className="flex items-center gap-2 cursor-pointer">
                    ...
                    />
                    <span className="text-sm text-gray-800">ตัวคูณ (Multiplier)</span>
                  </label>
                  <label className="flex items-center gap-2 cursor-pointer">
                    <input
                      type="radio"
                      ...
                      className="w-4 h-4 text-red-600 focus:ring-red-500"
                    />
                    <span className="text-sm text-gray-800">ราคาคงที่ (Fixed Price)</span>
                  </label>
                </div>
              </div>
              ...
              <div>
                ...
                <div className="flex gap-2 mb-2">
                  <button
                    ...
                    className="px-2 py-1 text-xs bg-gray-100 text-gray-800 hover:bg-gray-100 rounded transition-colors"
                  >
                    ทุกวัน
                  </button>
                  <button
